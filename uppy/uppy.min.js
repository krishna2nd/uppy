...
"use strict";function newRequest(){return new window.XMLHttpRequest}Object.defineProperty(exports,"__esModule",{value:!0}),exports.newRequest=newRequest;
...
(function (global){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}exports.__esModule=!0;var _extends=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var i=arguments[e];for(var s in i)Object.prototype.hasOwnProperty.call(i,s)&&(t[s]=i[s])}return t},_Utils=require("../core/Utils"),_Utils2=_interopRequireDefault(_Utils),_Translator=require("../core/Translator"),_Translator2=_interopRequireDefault(_Translator),_namespaceEmitter=require("namespace-emitter"),_namespaceEmitter2=_interopRequireDefault(_namespaceEmitter),_UppySocket=require("./UppySocket"),_UppySocket2=_interopRequireDefault(_UppySocket),_en_US=require("../locales/en_US"),_en_US2=_interopRequireDefault(_en_US),Core=function(){function t(e){_classCallCheck(this,t);var i={locales:_en_US2.default,autoProceed:!0,debug:!1};this.opts=_extends({},i,e),this.types=["presetter","orchestrator","progressindicator","acquirer","modifier","uploader","presenter","debugger"],this.type="core",this.plugins={},this.translator=new _Translator2.default({locales:this.opts.locales}),this.i18n=this.translator.translate.bind(this.translator),this.getState=this.getState.bind(this),this.updateMeta=this.updateMeta.bind(this),this.initSocket=this.initSocket.bind(this),this.log=this.log.bind(this),this.addFile=this.addFile.bind(this),this.bus=this.emitter=(0,_namespaceEmitter2.default)(),this.on=this.bus.on.bind(this.bus),this.emit=this.bus.emit.bind(this.bus),this.state={files:{},capabilities:{},totalProgress:0},this.opts.debug&&(global.UppyState=this.state,global.uppyLog="",global.UppyAddFile=this.addFile.bind(this),global._Uppy=this)}return t.prototype.updateAll=function(t){var e=this;Object.keys(this.plugins).forEach(function(i){e.plugins[i].forEach(function(e){e.update(t)})})},t.prototype.setState=function(t){var e=_extends({},this.state,t);this.bus.emit("core:state-update",this.state,e,t),this.state=e,this.updateAll(this.state)},t.prototype.getState=function(){return this.state},t.prototype.updateMeta=function(t,e){var i=_extends({},this.getState().files),s=_extends({},i[e].meta,t);i[e]=_extends({},i[e],{meta:s}),this.setState({files:i})},t.prototype.addFile=function(t){var e=_extends({},this.state.files),i=t.name||"noname",s=_Utils2.default.getFileType(t)?_Utils2.default.getFileType(t).split("/"):["",""],n=s[0],o=s[1],r=_Utils2.default.getFileNameAndExtension(i)[1],a=t.isRemote||!1,l=_Utils2.default.generateFileID(i),u={source:t.source||"",id:l,name:i,extension:r||"",meta:{name:i},type:{general:n,specific:o},data:t.data,progress:{percentage:0,uploadComplete:!1,uploadStarted:!1},size:t.data.size||0,isRemote:a,remote:t.remote||""};e[l]=u,this.setState({files:e}),this.bus.emit("file-added",l),this.log("Added file: "+i+", "+l),"image"!==n||a||this.addThumbnail(u.id),this.opts.autoProceed&&this.bus.emit("core:upload")},t.prototype.removeFile=function(t){var e=_extends({},this.getState().files);delete e[t],this.setState({files:e})},t.prototype.addThumbnail=function(t){var e=this,i=this.getState().files[t];_Utils2.default.readFile(i.data).then(function(t){return _Utils2.default.createImageThumbnail(t,200)}).then(function(i){var s=_extends({},e.getState().files),n=_extends({},s[t],{preview:i});s[t]=n,e.setState({files:s})})},t.prototype.actions=function(){var t=this;this.on("core:file-add",function(e){t.addFile(e)}),this.on("core:file-remove",function(e){t.removeFile(e)}),this.on("core:upload-started",function(e,i){var s=_extends({},t.getState().files),n=_extends({},s[e],_extends({},{progress:_extends({},s[e].progress,{uploadStarted:Date.now()})}));s[e]=n,t.setState({files:s})}),this.on("core:upload-progress",function(e){var i=e.id,s=_extends({},t.getState().files);if(!s[i])return void console.error("Trying to set progress for a file that’s not with us anymore: ",i);var n=_extends({},s[i],_extends({},{progress:_extends({},s[i].progress,{bytesUploaded:e.bytesUploaded,bytesTotal:e.bytesTotal,percentage:Math.round((e.bytesUploaded/e.bytesTotal*100).toFixed(2))})}));s[e.id]=n;var o=Object.keys(s).filter(function(t){return s[t].progress.uploadStarted}),r=100*o.length,a=0;o.forEach(function(t){a+=s[t].progress.percentage});var l=Math.round((100*a/r).toFixed(2));if(100===l){var u=Object.keys(s).filter(function(t){return 100===s[t].progress.percentage});t.emit("core:success",u.length)}t.setState({totalProgress:l,files:s})}),this.on("core:upload-success",function(e,i){var s=_extends({},t.getState().files),n=_extends({},s[e],{progress:_extends({},s[e].progress,{uploadComplete:!0}),uploadURL:i});s[e]=n,t.setState({files:s})}),this.on("core:update-meta",function(e,i){t.updateMeta(e,i)}),"undefined"!=typeof window&&(window.addEventListener("online",function(){return t.isOnline(!0)}),window.addEventListener("offline",function(){return t.isOnline(!1)}),setTimeout(function(){return t.isOnline()},3e3))},t.prototype.isOnline=function(t){var e=t||window.navigator.onLine;e?(this.emit("is-online"),this.wasOffline&&(this.emit("informer","Connected!","success",3e3),this.wasOffline=!1)):(this.emit("is-offline"),this.emit("informer","No internet connection","error",0),this.wasOffline=!0)},t.prototype.use=function(t,e){var i={getState:this.getState.bind(this),setState:this.setState.bind(this),updateMeta:this.updateMeta.bind(this),addFile:this.addFile.bind(this),i18n:this.i18n.bind(this),bus:this.ee,log:this.log.bind(this)},s=new t(this,e,i),n=s.id;if(this.plugins[s.type]=this.plugins[s.type]||[],!n)throw new Error("Your plugin must have a name");if(!s.type)throw new Error("Your plugin must have a type");var o=this.getPlugin(n);if(o){var r="Already found a plugin named '"+o.name+"'.\n        Tried to use: '"+n+"'.\n        Uppy is currently limited to running one of every plugin.\n        Share your use case with us over at\n        https://github.com/transloadit/uppy/issues/\n        if you want us to reconsider.";throw new Error(r)}return this.plugins[s.type].push(s),this},t.prototype.getPlugin=function(t){var e=!1;return this.iteratePlugins(function(i){var s=i.id;if(s===t)return e=i,!1}),e},t.prototype.iteratePlugins=function(t){var e=this;Object.keys(this.plugins).forEach(function(i){e.plugins[i].forEach(t)})},t.prototype.log=function(t){this.opts.debug&&(t===""+t?console.log("LOG: "+t):console.dir(t),global.uppyLog=global.uppyLog+"\nDEBUG LOG: "+t)},t.prototype.initSocket=function(t){return this.socket||(this.socket=new _UppySocket2.default(t)),this.socket},t.prototype.installAll=function(){var t=this;Object.keys(this.plugins).forEach(function(e){t.plugins[e].forEach(function(t){t.install()})})},t.prototype.run=function(){this.log("Core is run, initializing actions, installing plugins..."),this.actions(),this.installAll()},t}();exports.default=Core;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"../core/Translator":33,"../core/Utils":35,"../locales/en_US":39,"./UppySocket":34,"namespace-emitter":11}],33:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}exports.__esModule=!0;var _extends=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var r=arguments[e];for(var s in r)Object.prototype.hasOwnProperty.call(r,s)&&(t[s]=r[s])}return t},_en_US=require("../locales/en_US"),_en_US2=_interopRequireDefault(_en_US),Translator=function(){function t(e){_classCallCheck(this,t);var r={locales:_en_US2.default};this.opts=_extends({},r,e),this.locales=this.opts.locales,this.locales.strings=_extends({},_en_US2.default.strings,this.opts.locales.strings)}return t.prototype.interpolate=function(t,e){var r=String.prototype.replace,s=/\$/g,n="$$$$";for(var a in e)if("_"!==a&&e.hasOwnProperty(a)){var o=e[a];"string"==typeof o&&(o=r.call(e[a],s,n)),t=r.call(t,new RegExp("%\\{"+a+"\\}","g"),o)}return t},t.prototype.translate=function(t,e){if(e&&e.smart_count){var r=this.locales.pluralize(e.smart_count);return this.interpolate(this.opts.locales.strings[t][r],e)}return this.interpolate(this.opts.locales.strings[t],e)},t}();exports.default=Translator;
},{"../locales/en_US":39}],34:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}exports.__esModule=!0;var _namespaceEmitter=require("namespace-emitter"),_namespaceEmitter2=_interopRequireDefault(_namespaceEmitter),UppySocket=function(){function e(t){var i=this;_classCallCheck(this,e),this.queued=[],this.isOpen=!1,this.socket=new WebSocket(t.target),this.emitter=(0,_namespaceEmitter2.default)(),this.socket.onopen=function(e){for(i.isOpen=!0;i.queued.length>0&&i.isOpen;){var t=i.queued[0];i.send(t.action,t.payload),i.queued=i.queued.slice(1)}},this.socket.onclose=function(e){i.isOpen=!1},this._handleMessage=this._handleMessage.bind(this),this.socket.onmessage=this._handleMessage,this.close=this.close.bind(this),this.emit=this.emit.bind(this),this.on=this.on.bind(this),this.once=this.once.bind(this),this.send=this.send.bind(this)}return e.prototype.close=function(){return this.socket.close()},e.prototype.send=function(e,t){return this.isOpen?void this.socket.send(JSON.stringify({action:e,payload:t})):void this.queued.push({action:e,payload:t})},e.prototype.on=function(e,t){this.emitter.on(e,t)},e.prototype.emit=function(e,t){this.emitter.emit(e,t)},e.prototype.once=function(e,t){this.emitter.once(e,t)},e.prototype._handleMessage=function(e){try{var t=JSON.parse(e.data);this.emit(t.action,t.payload)}catch(e){console.log(e)}},e}();exports.default=UppySocket;
},{"namespace-emitter":11}],35:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function flatten(e){return[].concat.apply([],e)}function isTouchDevice(){return"ontouchstart"in window||navigator.maxTouchPoints}function $(e,t){return(t||document).querySelector(e)}function $$(e,t){var r;return"string"!=typeof e?(r=e,Array.prototype.slice.call(r)):void(r=(t||document).querySelectorAll(e))}function truncateString(e,t){return e.length>t?e.substr(0,t/2)+"..."+e.substr(e.length-t/4,e.length):e}function secondsToTime(e){var t=Math.floor(e/3600)%24,r=Math.floor(e/60)%60,o=Math.floor(e%60);return{hours:t,minutes:r,seconds:o}}function groupBy(e,t){return e.reduce(function(e,r){var o=t(r),n=e.get(o)||[];return n.push(r),e.set(o,n),e},new Map)}function every(e,t){return e.reduce(function(e,r){return!!e&&t(r)},!0)}function toArray(e){return Array.prototype.slice.call(e||[],0)}function generateFileID(e){var t=e.toLowerCase();return t=t.replace(/[^A-Z0-9]/gi,""),t+=Date.now()}function extend(){for(var e=arguments.length,t=Array(e),r=0;r<e;r++)t[r]=arguments[r];return Object.assign.apply(this,[{}].concat(t))}function getProportionalImageHeight(e,t){var r=e.width/e.height,o=Math.round(t/r);return o}function getFileType(e){return e.type?e.type:_mimeTypes2.default.lookup(e.name)}function getFileNameAndExtension(e){var t=/(?:\.([^.]+))?$/,r=t.exec(e)[1],o=e.replace("."+r,"");return[o,r]}function readFile(e){return new _Promise(function(t,r){var o=new FileReader;o.addEventListener("load",function(e){return t(e.target.result)}),o.readAsDataURL(e)})}function createImageThumbnail(e,t){return new _Promise(function(r,o){var n=new Image;n.addEventListener("load",function(){var e=t,o=getProportionalImageHeight(n,e),a=document.createElement("canvas"),i=a.getContext("2d");a.width=e,a.height=o,i.drawImage(n,0,0,e,o);var u=a.toDataURL("image/png");return r(u)}),n.src=e})}function dataURItoBlob(e,t,r){var o=e.split(",")[1],n=t.mimeType||e.split(",")[0].split(":")[1].split(";")[0];null==n&&(n="plain/text");for(var a=atob(o),i=[],u=0;u<a.length;u++)i.push(a.charCodeAt(u));return r?new File([new Uint8Array(i)],t.name||"",{type:n}):new Blob([new Uint8Array(i)],{type:n})}function dataURItoFile(e,t){return dataURItoBlob(e,t,!0)}function copyToClipboard(e,t){return t=t||"Copy the URL below",new _Promise(function(r,o){var n=document.createElement("textarea");n.setAttribute("style",{position:"fixed",top:0,left:0,width:"2em",height:"2em",padding:0,border:"none",outline:"none",boxShadow:"none",background:"transparent"}),n.value=e,document.body.appendChild(n),n.select();var a=function(r){return document.body.removeChild(n),window.prompt(t,e),o("Oops, unable to copy displayed fallback prompt: "+r)};try{var i=document.execCommand("copy");return i?(document.body.removeChild(n),r()):a("copy command unavailable")}catch(e){return document.body.removeChild(n),a(e)}})}function makeWorker(e){var t=window.URL||window.webkitURL,r=window.Blob,o=window.Worker;if(!(t&&r&&o&&e))return null;var n=e.toString();n=n.substring(n.indexOf("{")+1,n.lastIndexOf("}"));var a=new r([n]),i=new o(t.createObjectURL(a));return i}function getSpeed(e){if(!e.bytesUploaded)return 0;var t=new Date-e.uploadStarted,r=e.bytesUploaded/(t/1e3);return r}function getETA(e){if(!e.bytesUploaded)return 0;var t=getSpeed(e),r=e.bytesTotal-e.bytesUploaded,o=Math.round(r/t*10)/10;return o}function prettyETA(e){var t=secondsToTime(e),r=t.hours?t.hours+"h":"",o=t.hours||t.minutes?t.minutes+"m":"",n=t.seconds+"s";return r+" "+o+" "+n}exports.__esModule=!0,exports.flatten=flatten,exports.isTouchDevice=isTouchDevice,exports.$=$,exports.$$=$$,exports.truncateString=truncateString,exports.secondsToTime=secondsToTime,exports.groupBy=groupBy,exports.every=every,exports.toArray=toArray,exports.generateFileID=generateFileID,exports.extend=extend,exports.getProportionalImageHeight=getProportionalImageHeight,exports.getFileType=getFileType,exports.getFileNameAndExtension=getFileNameAndExtension,exports.readFile=readFile,exports.createImageThumbnail=createImageThumbnail,exports.dataURItoBlob=dataURItoBlob,exports.dataURItoFile=dataURItoFile,exports.copyToClipboard=copyToClipboard,exports.makeWorker=makeWorker,exports.getSpeed=getSpeed,exports.getETA=getETA,exports.prettyETA=prettyETA;var _mimeTypes=require("mime-types"),_mimeTypes2=_interopRequireDefault(_mimeTypes),_Promise="undefined"==typeof Promise?require("es6-promise").Promise:Promise;exports.default={generateFileID:generateFileID,toArray:toArray,every:every,flatten:flatten,groupBy:groupBy,$:$,$$:$$,extend:extend,readFile:readFile,createImageThumbnail:createImageThumbnail,getProportionalImageHeight:getProportionalImageHeight,isTouchDevice:isTouchDevice,getFileNameAndExtension:getFileNameAndExtension,truncateString:truncateString,getFileType:getFileType,secondsToTime:secondsToTime,dataURItoBlob:dataURItoBlob,dataURItoFile:dataURItoFile,getSpeed:getSpeed,getETA:getETA,makeWorker:makeWorker};
},{"es6-promise":7,"mime-types":8}],36:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}exports.__esModule=!0;var _yoYo=require("yo-yo"),_yoYo2=_interopRequireDefault(_yoYo);exports.default=_yoYo2.default;
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}exports.__esModule=!0,exports.Webcam=exports.MetaData=exports.Dashboard=exports.Multipart=exports.Tus10=exports.Formtag=exports.GoogleDrive=exports.DragDrop=exports.Informer=exports.ProgressBar=exports.Dummy=exports.locales=exports.Plugin=exports.Core=void 0;var _index=require("./core/index.js"),_index2=_interopRequireDefault(_index),_Plugin=require("./plugins/Plugin"),_Plugin2=_interopRequireDefault(_Plugin),_index3=require("./plugins/Dashboard/index.js"),_index4=_interopRequireDefault(_index3),_Dummy=require("./plugins/Dummy"),_Dummy2=_interopRequireDefault(_Dummy),_index5=require("./plugins/DragDrop/index.js"),_index6=_interopRequireDefault(_index5),_Formtag=require("./plugins/Formtag"),_Formtag2=_interopRequireDefault(_Formtag),_index7=require("./plugins/GoogleDrive/index.js"),_index8=_interopRequireDefault(_index7),_index9=require("./plugins/Webcam/index.js"),_index10=_interopRequireDefault(_index9),_ProgressBar=require("./plugins/ProgressBar.js"),_ProgressBar2=_interopRequireDefault(_ProgressBar),_Informer=require("./plugins/Informer.js"),_Informer2=_interopRequireDefault(_Informer),_MetaData=require("./plugins/MetaData.js"),_MetaData2=_interopRequireDefault(_MetaData),_Tus=require("./plugins/Tus10"),_Tus2=_interopRequireDefault(_Tus),_Multipart=require("./plugins/Multipart"),_Multipart2=_interopRequireDefault(_Multipart),locales={};exports.default={Core:_index2.default,Plugin:_Plugin2.default,locales:locales,Dummy:_Dummy2.default,ProgressBar:_ProgressBar2.default,Informer:_Informer2.default,DragDrop:_index6.default,GoogleDrive:_index8.default,Formtag:_Formtag2.default,Tus10:_Tus2.default,Multipart:_Multipart2.default,Dashboard:_index4.default,MetaData:_MetaData2.default,Webcam:_index10.default},exports.Core=_index2.default,exports.Plugin=_Plugin2.default,exports.locales=locales,exports.Dummy=_Dummy2.default,exports.ProgressBar=_ProgressBar2.default,exports.Informer=_Informer2.default,exports.DragDrop=_index6.default,exports.GoogleDrive=_index8.default,exports.Formtag=_Formtag2.default,exports.Tus10=_Tus2.default,exports.Multipart=_Multipart2.default,exports.Dashboard=_index4.default,exports.MetaData=_MetaData2.default,exports.Webcam=_index10.default;
...
"use strict";exports.__esModule=!0;var en_US={};en_US.strings={chooseFile:"Choose a file",youHaveChosen:"You have chosen: %{fileName}",orDragDrop:"or drag it here",filesChosen:{0:"%{smart_count} file selected",1:"%{smart_count} files selected"},filesUploaded:{0:"%{smart_count} file uploaded",1:"%{smart_count} files uploaded"},files:{0:"%{smart_count} file",1:"%{smart_count} files"},uploadFiles:{0:"Upload %{smart_count} file",1:"Upload %{smart_count} files"},selectToUpload:"Select files to upload",closeModal:"Close Modal",upload:"Upload",importFrom:"Import files from",dashboardWindowTitle:"Uppy Dashboard Window (Press escape to close)",dashboardTitle:"Uppy Dashboard",copyLinkToClipboardSuccess:"Link copied to clipboard.",copyLinkToClipboardFallback:"Copy the URL below",done:"Done",localDisk:"Local Disk",dropPasteImport:"Drop or paste files here, or import from one of the locations above",fileProgress:"File progress: upload speed and ETA",numberOfSelectedFiles:"Number of selected files",uploadAllNewFiles:"Upload all new files"},en_US.pluralize=function(e){return 1===e?0:1},"undefined"!=typeof window&&"undefined"!=typeof window.Uppy&&(window.Uppy.locales.en_US=en_US),exports.default=en_US;
},{}],40:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,a){return e.raw=a,e}function Dashboard(e){var a=function(a){a.preventDefault();var n=(0,_Utils.toArray)(a.target.files);n.forEach(function(a){e.addFile({source:e.id,name:a.name,type:a.type,data:a})})},n=function(a){a.preventDefault();var n=(0,_Utils.toArray)(a.clipboardData.items);n.forEach(function(a){if("file"===a.kind){var n=a.getAsFile();e.log("File pasted"),e.addFile({source:e.id,name:a.name,type:a.type,data:n})}})};return(0,_html2.default)(_templateObject,(0,_Utils.isTouchDevice)()?"Uppy--isTouchDevice":"",e.semiTransparent?"UppyDashboard--semiTransparent":"",e.inline?"":"UppyDashboard--modal",e.inline?"false":e.modal.isHidden,e.inline?e.i18n("dashboardTitle"):e.i18n("dashboardWindowTitle"),n,e.hideModal,e.i18n("closeModal"),e.i18n("closeModal"),e.hideModal,(0,_icons.closeIcon)(),(0,_Tabs2.default)({handleInputChange:a,acquirers:e.acquirers,container:e.container,panelSelectorPrefix:e.panelSelectorPrefix,showPanel:e.showPanel,i18n:e.i18n}),(0,_FileCard2.default)({files:e.files,fileCardFor:e.fileCardFor,done:e.fileCardDone,metaFields:e.metaFields,log:e.log,i18n:e.i18n}),(0,_FileList2.default)({files:e.files,showFileCard:e.showFileCard,showProgressDetails:e.showProgressDetails,totalProgress:e.totalProgress,totalFileCount:e.totalFileCount,info:e.info,i18n:e.i18n,log:e.log,removeFile:e.removeFile,pauseAll:e.pauseAll,resumeAll:e.resumeAll,pauseUpload:e.pauseUpload,startUpload:e.startUpload}),!e.autoProceed&&e.newFiles.length>0?(0,_UploadBtn2.default)({i18n:e.i18n,startUpload:e.startUpload,newFileCount:e.newFiles.length}):null,e.uploadStartedFiles.length>0?(0,_ProgressCircle2.default)({totalProgress:e.totalProgress,isAllPaused:e.isAllPaused,isAllComplete:e.isAllComplete,pauseAll:e.pauseAll,resumeAll:e.resumeAll}):null,e.uploadStartedFiles.length>0?(0,_StatusBar2.default)({totalProgress:e.totalProgress,isAllComplete:e.isAllComplete,isAllPaused:e.isAllPaused,complete:e.completeFiles.length,inProgress:e.uploadStartedFiles.length,totalSpeed:e.totalSpeed,totalETA:e.totalETA}):null,e.acquirers.map(function(a){return(0,_html2.default)(_templateObject2,e.panelSelectorPrefix,a.id,a.isHidden,e.i18n("importFrom"),a.name,e.hideAllPanels,e.i18n("done"),a.render(e.state))}),e.progressindicators.map(function(a){return a.render(e.state)}))}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(['<div class="Uppy UppyTheme--default UppyDashboard\n                          ',"\n                          ","\n                          ",'"\n                   aria-hidden="','"\n                   aria-label="','"\n                   role="dialog"\n                   onpaste=','>\n\n    <div class="UppyDashboard-overlay"\n         onclick=','>\n      <button class="UppyDashboard-close"\n              aria-label="','"\n              title="','"\n              onclick=',">",'</button>\n    </div>\n\n    <div class="UppyDashboard-inner" tabindex="0">\n      <div class="UppyDashboard-innerWrap">\n\n        ',"\n\n        ","\n\n        ",'\n\n        <div class="UppyDashboard-actions">\n          ',"\n\n          ","\n        </div>\n\n        ","\n\n        ",'\n\n        <div class="UppyDashboard-progressindicators">\n          ',"\n        </div>\n\n      </div>\n    </div>\n  </div>"],['<div class="Uppy UppyTheme--default UppyDashboard\n                          ',"\n                          ","\n                          ",'"\n                   aria-hidden="','"\n                   aria-label="','"\n                   role="dialog"\n                   onpaste=','>\n\n    <div class="UppyDashboard-overlay"\n         onclick=','>\n      <button class="UppyDashboard-close"\n              aria-label="','"\n              title="','"\n              onclick=',">",'</button>\n    </div>\n\n    <div class="UppyDashboard-inner" tabindex="0">\n      <div class="UppyDashboard-innerWrap">\n\n        ',"\n\n        ","\n\n        ",'\n\n        <div class="UppyDashboard-actions">\n          ',"\n\n          ","\n        </div>\n\n        ","\n\n        ",'\n\n        <div class="UppyDashboard-progressindicators">\n          ',"\n        </div>\n\n      </div>\n    </div>\n  </div>"]),_templateObject2=_taggedTemplateLiteralLoose(['<div class="UppyDashboardContent-panel"\n                           id="',"--",'"\n                           role="tabpanel"\n                           aria-hidden="','">\n             <div class="UppyDashboardContent-bar">\n               <h2 class="UppyDashboardContent-title">'," ",'</h2>\n               <button class="UppyDashboardContent-back"\n                       onclick=',">","</button>\n             </div>\n            ","\n          </div>"],['<div class="UppyDashboardContent-panel"\n                           id="',"--",'"\n                           role="tabpanel"\n                           aria-hidden="','">\n             <div class="UppyDashboardContent-bar">\n               <h2 class="UppyDashboardContent-title">'," ",'</h2>\n               <button class="UppyDashboardContent-back"\n                       onclick=',">","</button>\n             </div>\n            ","\n          </div>"]);exports.default=Dashboard;var _html=require("../../core/html"),_html2=_interopRequireDefault(_html),_FileList=require("./FileList"),_FileList2=_interopRequireDefault(_FileList),_Tabs=require("./Tabs"),_Tabs2=_interopRequireDefault(_Tabs),_FileCard=require("./FileCard"),_FileCard2=_interopRequireDefault(_FileCard),_UploadBtn=require("./UploadBtn"),_UploadBtn2=_interopRequireDefault(_UploadBtn),_ProgressCircle=require("./ProgressCircle"),_ProgressCircle2=_interopRequireDefault(_ProgressCircle),_StatusBar=require("./StatusBar"),_StatusBar2=_interopRequireDefault(_StatusBar),_Utils=require("../../core/Utils"),_icons=require("./icons");
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,a){return e.raw=a,e}function getIconByMime(e){switch(e){case"text":return(0,_icons.iconText)();case"audio":return(0,_icons.iconAudio)();default:return(0,_icons.iconFile)()}}function fileCard(e){function a(e){var a=e.target.value,t=e.target.attributes.name.value;l[t]=a}function t(t){var n=e.metaFields||[];return n.map(function(e){return(0,_html2.default)(_templateObject,e.name,e.id,t.meta[e.id],e.placeholder||"",a)})}var n=!!e.fileCardFor&&e.files[e.fileCardFor],l={};return(0,_html2.default)(_templateObject2,!e.fileCardFor,n.meta?n.meta.name:n.name,function(){return e.done(l,n.id)},e.fileCardFor?(0,_html2.default)(_templateObject3,n.preview?(0,_html2.default)(_templateObject4,n.name,n.preview):(0,_html2.default)(_templateObject5,getIconByMime(n.type.general)),n.meta.name,a,t(n)):null,function(){return e.done(l,n.id)},(0,_icons.checkIcon)())}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(['<fieldset class="UppyDashboardFileCard-fieldset">\n        <label class="UppyDashboardFileCard-label">','</label>\n        <input class="UppyDashboardFileCard-input"\n                         name="','"\n                         type="text"\n                         value="','"\n                         placeholder="','"\n                         onkeyup='," /></fieldset>"],['<fieldset class="UppyDashboardFileCard-fieldset">\n        <label class="UppyDashboardFileCard-label">','</label>\n        <input class="UppyDashboardFileCard-input"\n                         name="','"\n                         type="text"\n                         value="','"\n                         placeholder="','"\n                         onkeyup='," /></fieldset>"]),_templateObject2=_taggedTemplateLiteralLoose(['<div class="UppyDashboardFileCard" aria-hidden="','">\n    <div class="UppyDashboardContent-bar">\n      <h2 class="UppyDashboardContent-title">Editing <span class="UppyDashboardContent-titleFile">','</span></h2>\n      <button class="UppyDashboardContent-back" title="Finish editing file"\n              onclick=',">Done</button>\n    </div>\n    ",'\n    <button class="UppyButton--circular UppyButton--blue UppyButton--sizeM UppyDashboardFileCard-done" type="button"\n            title="Finish editing file" onclick=',">","</button>\n    </div>"],['<div class="UppyDashboardFileCard" aria-hidden="','">\n    <div class="UppyDashboardContent-bar">\n      <h2 class="UppyDashboardContent-title">Editing <span class="UppyDashboardContent-titleFile">','</span></h2>\n      <button class="UppyDashboardContent-back" title="Finish editing file"\n              onclick=',">Done</button>\n    </div>\n    ",'\n    <button class="UppyButton--circular UppyButton--blue UppyButton--sizeM UppyDashboardFileCard-done" type="button"\n            title="Finish editing file" onclick=',">","</button>\n    </div>"]),_templateObject3=_taggedTemplateLiteralLoose(['<div class="UppyDashboardFileCard-inner">\n          <div class="UppyDashboardFileCard-preview">\n            ','\n          </div>\n          <div class="UppyDashboardFileCard-info">\n            <fieldset class="UppyDashboardFileCard-fieldset">\n              <label class="UppyDashboardFileCard-label">Name</label>\n              <input class="UppyDashboardFileCard-input" name="name" type="text" value="','"\n                     onkeyup='," />\n            </fieldset>\n            ","\n          </div>\n        </div>"],['<div class="UppyDashboardFileCard-inner">\n          <div class="UppyDashboardFileCard-preview">\n            ','\n          </div>\n          <div class="UppyDashboardFileCard-info">\n            <fieldset class="UppyDashboardFileCard-fieldset">\n              <label class="UppyDashboardFileCard-label">Name</label>\n              <input class="UppyDashboardFileCard-input" name="name" type="text" value="','"\n                     onkeyup='," />\n            </fieldset>\n            ","\n          </div>\n        </div>"]),_templateObject4=_taggedTemplateLiteralLoose(['<img alt="','" src="','">'],['<img alt="','" src="','">']),_templateObject5=_taggedTemplateLiteralLoose(['<div class="UppyDashboardItem-previewIcon">',"</div>"],['<div class="UppyDashboardItem-previewIcon">',"</div>"]);exports.default=fileCard;var _html=require("../../core/html"),_html2=_interopRequireDefault(_html),_icons=require("./icons");
},{"../../core/html":36,"./icons":49}],42:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,t){return e.raw=t,e}function getIconByMime(e){switch(e){case"text":return(0,_icons.iconText)();case"audio":return(0,_icons.iconAudio)();default:return(0,_icons.iconFile)()}}function fileItem(e){var t=e.file,a=t.progress.uploadComplete,n=t.progress.uploadStarted,l=t.progress.uploadStarted&&!t.progress.uploadComplete,s=t.isPaused||!1,i=(0,_Utils.getFileNameAndExtension)(t.meta.name)[0],o=(0,_Utils.truncateString)(i,15);return(0,_html2.default)(_templateObject,l?"is-inprogress":"",a?"is-complete":"",s?"is-paused":"",t.id,t.meta.name,t.preview?(0,_html2.default)(_templateObject2,t.name,t.preview):getIconByMime(t.type.general),a?"upload complete":t.isPaused?"resume upload":"pause upload",function(n){a||e.pauseUpload(t.id)},(0,_FileItemProgress2.default)({progress:t.progress.percentage,fileID:t.id}),e.showProgressDetails?(0,_html2.default)(_templateObject3,e.i18n("localDisk"),e.i18n("localDisk"),t.isPaused||a?null:(0,_html2.default)(_templateObject4,(0,_Utils.prettyETA)((0,_Utils.getETA)(t.progress)),(0,_prettyBytes2.default)((0,_Utils.getSpeed)(t.progress)))):null,i,t.uploadURL?(0,_html2.default)(_templateObject5,t.uploadURL,t.extension?o+"."+t.extension:o):t.extension?o+"."+t.extension:o,t.data.size?(0,_prettyBytes2.default)(t.data.size):"?",n?null:(0,_html2.default)(_templateObject6,function(a){return e.showFileCard(t.id)},(0,_icons.iconEdit)()),t.uploadURL?(0,_html2.default)(_templateObject7,function(){(0,_Utils.copyToClipboard)(t.uploadURL,e.i18n("copyLinkToClipboardFallback")).then(function(){e.log("Link copied to clipboard."),e.info(e.i18n("copyLinkToClipboardSuccess"),"info",3e3)}).catch(e.log)},(0,_icons.iconCopy)()):null,a?null:(0,_html2.default)(_templateObject8,function(){return e.removeFile(t.id)}))}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(['<li class="UppyDashboardItem\n                        ',"\n                        ","\n                        ",'"\n                  id="uppy_','"\n                  title="','">\n      <div class="UppyDashboardItem-preview">\n        ','\n        <div class="UppyDashboardItem-progress">\n          <button class="UppyDashboardItem-progressBtn"\n                  title="','"\n                  onclick=',">\n            ","\n          </button>\n          ",'\n        </div>\n      </div>\n    <div class="UppyDashboardItem-info">\n      <h4 class="UppyDashboardItem-name" title="','">\n        ','\n      </h4>\n      <div class="UppyDashboardItem-status">\n        <span class="UppyDashboardItem-statusSize">',"</span>\n      </div>\n      ","\n      ",'\n    </div>\n    <div class="UppyDashboardItem-action">\n      ',"\n    </div>\n  </li>"],['<li class="UppyDashboardItem\n                        ',"\n                        ","\n                        ",'"\n                  id="uppy_','"\n                  title="','">\n      <div class="UppyDashboardItem-preview">\n        ','\n        <div class="UppyDashboardItem-progress">\n          <button class="UppyDashboardItem-progressBtn"\n                  title="','"\n                  onclick=',">\n            ","\n          </button>\n          ",'\n        </div>\n      </div>\n    <div class="UppyDashboardItem-info">\n      <h4 class="UppyDashboardItem-name" title="','">\n        ','\n      </h4>\n      <div class="UppyDashboardItem-status">\n        <span class="UppyDashboardItem-statusSize">',"</span>\n      </div>\n      ","\n      ",'\n    </div>\n    <div class="UppyDashboardItem-action">\n      ',"\n    </div>\n  </li>"]),_templateObject2=_taggedTemplateLiteralLoose(['<img alt="','" src="','">'],['<img alt="','" src="','">']),_templateObject3=_taggedTemplateLiteralLoose(['<div class="UppyDashboardItem-progressInfo"\n                   title="','"\n                   aria-label="','">\n                ',"\n              </div>"],['<div class="UppyDashboardItem-progressInfo"\n                   title="','"\n                   aria-label="','">\n                ',"\n              </div>"]),_templateObject4=_taggedTemplateLiteralLoose(["<span>"," ・ ↑ ","/s</span>"],["<span>"," ・ ↑ ","/s</span>"]),_templateObject5=_taggedTemplateLiteralLoose(['<a href="','" target="_blank">\n              ',"\n            </a>"],['<a href="','" target="_blank">\n              ',"\n            </a>"]),_templateObject6=_taggedTemplateLiteralLoose(['<button class="UppyDashboardItem-edit"\n                       aria-label="Edit file"\n                       title="Edit file"\n                       onclick=',">\n                        ","</button>"],['<button class="UppyDashboardItem-edit"\n                       aria-label="Edit file"\n                       title="Edit file"\n                       onclick=',">\n                        ","</button>"]),_templateObject7=_taggedTemplateLiteralLoose(['<button class="UppyDashboardItem-copyLink"\n                       aria-label="Copy link"\n                       title="Copy link"\n                       onclick=',">","</button>"],['<button class="UppyDashboardItem-copyLink"\n                       aria-label="Copy link"\n                       title="Copy link"\n                       onclick=',">","</button>"]),_templateObject8=_taggedTemplateLiteralLoose(['<button class="UppyDashboardItem-remove"\n                       aria-label="Remove file"\n                       title="Remove file"\n                       onclick=','>\n                 <svg width="22" height="21" viewBox="0 0 18 17">\n                   <ellipse fill="#000" cx="8.62" cy="8.383" rx="8.62" ry="8.383"/>\n                   <path stroke="#FFF" fill="#FFF" d="M11 6.147L10.85 6 8.5 8.284 6.15 6 6 6.147 8.35 8.43 6 10.717l.15.146L8.5 8.578l2.35 2.284.15-.146L8.65 8.43z"/>\n                 </svg>\n               </button>'],['<button class="UppyDashboardItem-remove"\n                       aria-label="Remove file"\n                       title="Remove file"\n                       onclick=','>\n                 <svg width="22" height="21" viewBox="0 0 18 17">\n                   <ellipse fill="#000" cx="8.62" cy="8.383" rx="8.62" ry="8.383"/>\n                   <path stroke="#FFF" fill="#FFF" d="M11 6.147L10.85 6 8.5 8.284 6.15 6 6 6.147 8.35 8.43 6 10.717l.15.146L8.5 8.578l2.35 2.284.15-.146L8.65 8.43z"/>\n                 </svg>\n               </button>']);exports.default=fileItem;var _html=require("../../core/html"),_html2=_interopRequireDefault(_html),_Utils=require("../../core/Utils"),_prettyBytes=require("pretty-bytes"),_prettyBytes2=_interopRequireDefault(_prettyBytes),_FileItemProgress=require("./FileItemProgress"),_FileItemProgress2=_interopRequireDefault(_FileItemProgress),_icons=require("./icons");
},{"../../core/Utils":35,"../../core/html":36,"./FileItemProgress":43,"./icons":49,"pretty-bytes":12}],43:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _taggedTemplateLiteralLoose(t,e){return t.raw=e,t}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(['\n    <svg width="70" height="70" viewBox="0 0 36 36" class="UppyIcon UppyIcon-progressCircle">\n      <g class="progress-group">\n        <circle r="15" cx="18" cy="18" stroke-width="2" fill="none" class="bg"/>\n        <circle r="15" cx="18" cy="18" transform="rotate(-90, 18, 18)" stroke-width="2" fill="none" stroke-dasharray="100" stroke-dashoffset="','" class="progress"/>\n      </g>\n      <polygon transform="translate(3, 3)" points="12 20 12 10 20 15" class="play"/>\n      <g transform="translate(14.5, 13)" class="pause">\n        <rect x="0" y="0" width="2" height="10" rx="0" />\n        <rect x="5" y="0" width="2" height="10" rx="0" />\n      </g>\n      <polygon transform="translate(2, 3)" points="14 22.5 7 15.2457065 8.99985857 13.1732815 14 18.3547104 22.9729883 9 25 11.1005634" class="check"/>\n  </svg>'],['\n    <svg width="70" height="70" viewBox="0 0 36 36" class="UppyIcon UppyIcon-progressCircle">\n      <g class="progress-group">\n        <circle r="15" cx="18" cy="18" stroke-width="2" fill="none" class="bg"/>\n        <circle r="15" cx="18" cy="18" transform="rotate(-90, 18, 18)" stroke-width="2" fill="none" stroke-dasharray="100" stroke-dashoffset="','" class="progress"/>\n      </g>\n      <polygon transform="translate(3, 3)" points="12 20 12 10 20 15" class="play"/>\n      <g transform="translate(14.5, 13)" class="pause">\n        <rect x="0" y="0" width="2" height="10" rx="0" />\n        <rect x="5" y="0" width="2" height="10" rx="0" />\n      </g>\n      <polygon transform="translate(2, 3)" points="14 22.5 7 15.2457065 8.99985857 13.1732815 14 18.3547104 22.9729883 9 25 11.1005634" class="check"/>\n  </svg>']);exports.default=function(t){return(0,_html2.default)(_templateObject,100-t.progress||100)};var _html=require("../../core/html"),_html2=_interopRequireDefault(_html);
},{"../../core/html":36}],44:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,l){return e.raw=l,e}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(['<ul class="UppyDashboard-files\n                         ','">\n      ',"\n      ","\n    </ul>"],['<ul class="UppyDashboard-files\n                         ','">\n      ',"\n      ","\n    </ul>"]),_templateObject2=_taggedTemplateLiteralLoose(['<div class="UppyDashboard-bgIcon">\n        ','\n        <h4 class="UppyDashboard-dropFilesTitle">',"</h4>\n       </div>"],['<div class="UppyDashboard-bgIcon">\n        ','\n        <h4 class="UppyDashboard-dropFilesTitle">',"</h4>\n       </div>"]),_html=require("../../core/html"),_html2=_interopRequireDefault(_html),_FileItem=require("./FileItem"),_FileItem2=_interopRequireDefault(_FileItem),_icons=require("./icons");exports.default=function(e){return(0,_html2.default)(_templateObject,0===e.totalFileCount?"UppyDashboard-files--noFiles":"",0===e.totalFileCount?(0,_html2.default)(_templateObject2,(0,_icons.dashboardBgIcon)(),e.i18n("dropPasteImport")):null,Object.keys(e.files).map(function(l){return(0,_FileItem2.default)({file:e.files[l],showFileCard:e.showFileCard,showProgressDetails:e.showProgressDetails,info:e.info,log:e.log,i18n:e.i18n,removeFile:e.removeFile,pauseUpload:e.pauseUpload})}))};
},{"../../core/html":36,"./FileItem":42,"./icons":49}],45:[function(require,module,exports){
"use strict";function _interopRequireDefault(s){return s&&s.__esModule?s:{default:s}}function _taggedTemplateLiteralLoose(s,t){return s.raw=t,s}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(['\n    <div class="UppyDashboard-actionsItem">\n      <button class="UppyTotalProgress\n                    ',"\n                    ",'"\n              onclick=','>\n          <svg width="70" height="70" viewBox="0 0 36 36" class="UppyIcon">\n            <g class="progress-group">\n              <circle r="15" cx="18" cy="18" stroke-width="2" fill="none" class="bg"/>\n              <circle r="15" cx="18" cy="18" transform="rotate(-90, 18, 18)" stroke-width="2" fill="none" stroke-dasharray="100" stroke-dashoffset="','" class="progress"/>\n            </g>\n            <polygon transform="translate(3, 3)" points="12 20 12 10 20 15" class="play"/>\n            <g transform="translate(14.5, 13)" class="pause">\n              <rect x="0" y="0" width="2" height="10" rx="0" />\n              <rect x="5" y="0" width="2" height="10" rx="0" />\n            </g>\n            <polygon transform="translate(2, 3)" points="14 22.5 7 15.2457065 8.99985857 13.1732815 14 18.3547104 22.9729883 9 25 11.1005634" class="check"/>\n        </svg>\n      </button>\n    </div>'],['\n    <div class="UppyDashboard-actionsItem">\n      <button class="UppyTotalProgress\n                    ',"\n                    ",'"\n              onclick=','>\n          <svg width="70" height="70" viewBox="0 0 36 36" class="UppyIcon">\n            <g class="progress-group">\n              <circle r="15" cx="18" cy="18" stroke-width="2" fill="none" class="bg"/>\n              <circle r="15" cx="18" cy="18" transform="rotate(-90, 18, 18)" stroke-width="2" fill="none" stroke-dasharray="100" stroke-dashoffset="','" class="progress"/>\n            </g>\n            <polygon transform="translate(3, 3)" points="12 20 12 10 20 15" class="play"/>\n            <g transform="translate(14.5, 13)" class="pause">\n              <rect x="0" y="0" width="2" height="10" rx="0" />\n              <rect x="5" y="0" width="2" height="10" rx="0" />\n            </g>\n            <polygon transform="translate(2, 3)" points="14 22.5 7 15.2457065 8.99985857 13.1732815 14 18.3547104 22.9729883 9 25 11.1005634" class="check"/>\n        </svg>\n      </button>\n    </div>']),_html=require("../../core/html"),_html2=_interopRequireDefault(_html);exports.default=function(s){s=s||{};var t=function(){if(!s.isAllComplete)return s.isAllPaused?s.resumeAll():s.pauseAll()};return(0,_html2.default)(_templateObject,s.isAllPaused?"UppyTotalProgress--is-paused":"",s.isAllComplete?"UppyTotalProgress--is-complete":"",t,100-s.totalProgress||100)};
},{"../../core/html":36}],46:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,t){return e.raw=t,e}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(['\n    <div class="UppyDashboard-statusBar">\n      ',"\n    </div>"],['\n    <div class="UppyDashboard-statusBar">\n      ',"\n    </div>"]),_html=require("../../core/html"),_html2=_interopRequireDefault(_html);exports.default=function(e){return e=e||{},(0,_html2.default)(_templateObject,e.isAllComplete?null:e.isAllPaused?"Paused ・"+e.totalProgress+"%":"Uploading... "+e.complete+" / "+e.inProgress+"・"+(e.totalProgress||0)+"%・"+e.totalETA+"・↑ "+e.totalSpeed+"/s")};
},{"../../core/html":36}],47:[function(require,module,exports){
"use strict";function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}function _taggedTemplateLiteralLoose(a,n){return a.raw=n,a}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(['<div class="UppyDashboardTabs">\n    <nav>\n      <ul class="UppyDashboardTabs-list" role="tablist">\n        <li class="UppyDashboardTab">\n          <button class="UppyDashboardTab-btn UppyDashboard-focus"\n                  role="tab"\n                  tabindex="0"\n                  onclick=',">\n            ",'\n            <h5 class="UppyDashboardTab-name">','</h5>\n          </button>\n          <input class="UppyDashboard-input" type="file" name="files[]" multiple="true"\n                 onchange='," />\n        </li>\n        ","\n      </ul>\n    </nav>\n  </div>"],['<div class="UppyDashboardTabs">\n    <nav>\n      <ul class="UppyDashboardTabs-list" role="tablist">\n        <li class="UppyDashboardTab">\n          <button class="UppyDashboardTab-btn UppyDashboard-focus"\n                  role="tab"\n                  tabindex="0"\n                  onclick=',">\n            ",'\n            <h5 class="UppyDashboardTab-name">','</h5>\n          </button>\n          <input class="UppyDashboard-input" type="file" name="files[]" multiple="true"\n                 onchange='," />\n        </li>\n        ","\n      </ul>\n    </nav>\n  </div>"]),_templateObject2=_taggedTemplateLiteralLoose(['<li class="UppyDashboardTab">\n            <button class="UppyDashboardTab-btn"\n                    role="tab"\n                    tabindex="0"\n                    aria-controls="',"--",'"\n                    aria-selected="','"\n                    onclick=',">\n              ",'\n              <h5 class="UppyDashboardTab-name">',"</h5>\n            </button>\n          </li>"],['<li class="UppyDashboardTab">\n            <button class="UppyDashboardTab-btn"\n                    role="tab"\n                    tabindex="0"\n                    aria-controls="',"--",'"\n                    aria-selected="','"\n                    onclick=',">\n              ",'\n              <h5 class="UppyDashboardTab-name">',"</h5>\n            </button>\n          </li>"]),_html=require("../../core/html"),_html2=_interopRequireDefault(_html),_icons=require("./icons");exports.default=function(a){return(0,_html2.default)(_templateObject,function(n){var e=document.querySelector(a.container+" .UppyDashboard-input");e.click()},(0,_icons.localIcon)(),a.i18n("localDisk"),a.handleInputChange,a.acquirers.map(function(n){return(0,_html2.default)(_templateObject2,a.panelSelectorPrefix,n.id,n.isHidden?"false":"true",function(){return a.showPanel(n.id)},n.icon,n.name)}))};
},{"../../core/html":36,"./icons":49}],48:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _taggedTemplateLiteralLoose(t,e){return t.raw=e,t}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(['<button class="UppyButton--circular\n                   UppyButton--blue\n                   UppyButton--sizeM\n                   UppyDashboard-upload"\n                 type="button"\n                 title="','"\n                 aria-label="','"\n                 onclick=',">\n            ",'\n            <sup class="UppyDashboard-uploadCount"\n                 title="','"\n                 aria-label="','">\n                  ',"</sup>\n    </button>\n  "],['<button class="UppyButton--circular\n                   UppyButton--blue\n                   UppyButton--sizeM\n                   UppyDashboard-upload"\n                 type="button"\n                 title="','"\n                 aria-label="','"\n                 onclick=',">\n            ",'\n            <sup class="UppyDashboard-uploadCount"\n                 title="','"\n                 aria-label="','">\n                  ',"</sup>\n    </button>\n  "]),_html=require("../../core/html"),_html2=_interopRequireDefault(_html),_icons=require("./icons");exports.default=function(t){return t=t||{},(0,_html2.default)(_templateObject,t.i18n("uploadAllNewFiles"),t.i18n("uploadAllNewFiles"),t.startUpload,(0,_icons.uploadIcon)(),t.i18n("numberOfSelectedFiles"),t.i18n("numberOfSelectedFiles"),t.newFileCount)};
},{"../../core/html":36,"./icons":49}],49:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _taggedTemplateLiteralLoose(t,e){return t.raw=e,t}function defaultTabIcon(){return(0,_html2.default)(_templateObject)}function iconCopy(){return(0,_html2.default)(_templateObject2)}function iconResume(){return(0,_html2.default)(_templateObject3)}function iconPause(){return(0,_html2.default)(_templateObject4)}function iconEdit(){return(0,_html2.default)(_templateObject5)}function localIcon(){return(0,_html2.default)(_templateObject6)}function closeIcon(){return(0,_html2.default)(_templateObject7)}function pluginIcon(){return(0,_html2.default)(_templateObject8)}function checkIcon(){return(0,_html2.default)(_templateObject9)}function iconAudio(){return(0,_html2.default)(_templateObject10)}function iconFile(){return(0,_html2.default)(_templateObject11)}function iconText(){return(0,_html2.default)(_templateObject12)}function removeIcon(){return(0,_html2.default)(_templateObject13)}function uploadIcon(){return(0,_html2.default)(_templateObject14)}function dashboardBgIcon(){return(0,_html2.default)(_templateObject15)}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(['<svg class="UppyIcon" width="30" height="30" viewBox="0 0 30 30">\n    <path d="M15 30c8.284 0 15-6.716 15-15 0-8.284-6.716-15-15-15C6.716 0 0 6.716 0 15c0 8.284 6.716 15 15 15zm4.258-12.676v6.846h-8.426v-6.846H5.204l9.82-12.364 9.82 12.364H19.26z" />\n  </svg>'],['<svg class="UppyIcon" width="30" height="30" viewBox="0 0 30 30">\n    <path d="M15 30c8.284 0 15-6.716 15-15 0-8.284-6.716-15-15-15C6.716 0 0 6.716 0 15c0 8.284 6.716 15 15 15zm4.258-12.676v6.846h-8.426v-6.846H5.204l9.82-12.364 9.82 12.364H19.26z" />\n  </svg>']),_templateObject2=_taggedTemplateLiteralLoose(['<svg class="UppyIcon" width="51" height="51" viewBox="0 0 51 51">\n    <path d="M17.21 45.765a5.394 5.394 0 0 1-7.62 0l-4.12-4.122a5.393 5.393 0 0 1 0-7.618l6.774-6.775-2.404-2.404-6.775 6.776c-3.424 3.427-3.424 9 0 12.426l4.12 4.123a8.766 8.766 0 0 0 6.216 2.57c2.25 0 4.5-.858 6.214-2.57l13.55-13.552a8.72 8.72 0 0 0 2.575-6.213 8.73 8.73 0 0 0-2.575-6.213l-4.123-4.12-2.404 2.404 4.123 4.12a5.352 5.352 0 0 1 1.58 3.81c0 1.438-.562 2.79-1.58 3.808l-13.55 13.55z"/>\n    <path d="M44.256 2.858A8.728 8.728 0 0 0 38.043.283h-.002a8.73 8.73 0 0 0-6.212 2.574l-13.55 13.55a8.725 8.725 0 0 0-2.575 6.214 8.73 8.73 0 0 0 2.574 6.216l4.12 4.12 2.405-2.403-4.12-4.12a5.357 5.357 0 0 1-1.58-3.812c0-1.437.562-2.79 1.58-3.808l13.55-13.55a5.348 5.348 0 0 1 3.81-1.58c1.44 0 2.792.562 3.81 1.58l4.12 4.12c2.1 2.1 2.1 5.518 0 7.617L39.2 23.775l2.404 2.404 6.775-6.777c3.426-3.427 3.426-9 0-12.426l-4.12-4.12z"/>\n  </svg>'],['<svg class="UppyIcon" width="51" height="51" viewBox="0 0 51 51">\n    <path d="M17.21 45.765a5.394 5.394 0 0 1-7.62 0l-4.12-4.122a5.393 5.393 0 0 1 0-7.618l6.774-6.775-2.404-2.404-6.775 6.776c-3.424 3.427-3.424 9 0 12.426l4.12 4.123a8.766 8.766 0 0 0 6.216 2.57c2.25 0 4.5-.858 6.214-2.57l13.55-13.552a8.72 8.72 0 0 0 2.575-6.213 8.73 8.73 0 0 0-2.575-6.213l-4.123-4.12-2.404 2.404 4.123 4.12a5.352 5.352 0 0 1 1.58 3.81c0 1.438-.562 2.79-1.58 3.808l-13.55 13.55z"/>\n    <path d="M44.256 2.858A8.728 8.728 0 0 0 38.043.283h-.002a8.73 8.73 0 0 0-6.212 2.574l-13.55 13.55a8.725 8.725 0 0 0-2.575 6.214 8.73 8.73 0 0 0 2.574 6.216l4.12 4.12 2.405-2.403-4.12-4.12a5.357 5.357 0 0 1-1.58-3.812c0-1.437.562-2.79 1.58-3.808l13.55-13.55a5.348 5.348 0 0 1 3.81-1.58c1.44 0 2.792.562 3.81 1.58l4.12 4.12c2.1 2.1 2.1 5.518 0 7.617L39.2 23.775l2.404 2.404 6.775-6.777c3.426-3.427 3.426-9 0-12.426l-4.12-4.12z"/>\n  </svg>']),_templateObject3=_taggedTemplateLiteralLoose(['<svg class="UppyIcon" width="25" height="25" viewBox="0 0 44 44">\n    <polygon class="play" transform="translate(6, 5.5)" points="13 21.6666667 13 11 21 16.3333333" />\n  </svg>'],['<svg class="UppyIcon" width="25" height="25" viewBox="0 0 44 44">\n    <polygon class="play" transform="translate(6, 5.5)" points="13 21.6666667 13 11 21 16.3333333" />\n  </svg>']),_templateObject4=_taggedTemplateLiteralLoose(['<svg class="UppyIcon" width="25px" height="25px" viewBox="0 0 44 44">\n    <g transform="translate(18, 17)" class="pause">\n      <rect x="0" y="0" width="2" height="10" rx="0" />\n      <rect x="6" y="0" width="2" height="10" rx="0" />\n    </g>\n  </svg>'],['<svg class="UppyIcon" width="25px" height="25px" viewBox="0 0 44 44">\n    <g transform="translate(18, 17)" class="pause">\n      <rect x="0" y="0" width="2" height="10" rx="0" />\n      <rect x="6" y="0" width="2" height="10" rx="0" />\n    </g>\n  </svg>']),_templateObject5=_taggedTemplateLiteralLoose(['<svg class="UppyIcon" width="28" height="28" viewBox="0 0 28 28">\n    <path d="M25.436 2.566a7.98 7.98 0 0 0-2.078-1.51C22.638.703 21.906.5 21.198.5a3 3 0 0 0-1.023.17 2.436 2.436 0 0 0-.893.562L2.292 18.217.5 27.5l9.28-1.796 16.99-16.99c.255-.254.444-.56.562-.888a3 3 0 0 0 .17-1.023c0-.708-.205-1.44-.555-2.16a8 8 0 0 0-1.51-2.077zM9.01 24.252l-4.313.834c0-.03.008-.06.012-.09.007-.944-.74-1.715-1.67-1.723-.04 0-.078.007-.118.01l.83-4.29L17.72 5.024l5.264 5.264L9.01 24.252zm16.84-16.96a.818.818 0 0 1-.194.31l-1.57 1.57-5.26-5.26 1.57-1.57a.82.82 0 0 1 .31-.194 1.45 1.45 0 0 1 .492-.074c.397 0 .917.126 1.468.397.55.27 1.13.678 1.656 1.21.53.53.94 1.11 1.208 1.655.272.55.397 1.07.393 1.468.004.193-.027.358-.074.488z" />\n  </svg>'],['<svg class="UppyIcon" width="28" height="28" viewBox="0 0 28 28">\n    <path d="M25.436 2.566a7.98 7.98 0 0 0-2.078-1.51C22.638.703 21.906.5 21.198.5a3 3 0 0 0-1.023.17 2.436 2.436 0 0 0-.893.562L2.292 18.217.5 27.5l9.28-1.796 16.99-16.99c.255-.254.444-.56.562-.888a3 3 0 0 0 .17-1.023c0-.708-.205-1.44-.555-2.16a8 8 0 0 0-1.51-2.077zM9.01 24.252l-4.313.834c0-.03.008-.06.012-.09.007-.944-.74-1.715-1.67-1.723-.04 0-.078.007-.118.01l.83-4.29L17.72 5.024l5.264 5.264L9.01 24.252zm16.84-16.96a.818.818 0 0 1-.194.31l-1.57 1.57-5.26-5.26 1.57-1.57a.82.82 0 0 1 .31-.194 1.45 1.45 0 0 1 .492-.074c.397 0 .917.126 1.468.397.55.27 1.13.678 1.656 1.21.53.53.94 1.11 1.208 1.655.272.55.397 1.07.393 1.468.004.193-.027.358-.074.488z" />\n  </svg>']),_templateObject6=_taggedTemplateLiteralLoose(['<svg class="UppyIcon" width="27" height="25" viewBox="0 0 27 25">\n    <path d="M5.586 9.288a.313.313 0 0 0 .282.176h4.84v3.922c0 1.514 1.25 2.24 2.792 2.24 1.54 0 2.79-.726 2.79-2.24V9.464h4.84c.122 0 .23-.068.284-.176a.304.304 0 0 0-.046-.324L13.735.106a.316.316 0 0 0-.472 0l-7.63 8.857a.302.302 0 0 0-.047.325z"/>\n    <path d="M24.3 5.093c-.218-.76-.54-1.187-1.208-1.187h-4.856l1.018 1.18h3.948l2.043 11.038h-7.193v2.728H9.114v-2.725h-7.36l2.66-11.04h3.33l1.018-1.18H3.907c-.668 0-1.06.46-1.21 1.186L0 16.456v7.062C0 24.338.676 25 1.51 25h23.98c.833 0 1.51-.663 1.51-1.482v-7.062L24.3 5.093z"/>\n  </svg>'],['<svg class="UppyIcon" width="27" height="25" viewBox="0 0 27 25">\n    <path d="M5.586 9.288a.313.313 0 0 0 .282.176h4.84v3.922c0 1.514 1.25 2.24 2.792 2.24 1.54 0 2.79-.726 2.79-2.24V9.464h4.84c.122 0 .23-.068.284-.176a.304.304 0 0 0-.046-.324L13.735.106a.316.316 0 0 0-.472 0l-7.63 8.857a.302.302 0 0 0-.047.325z"/>\n    <path d="M24.3 5.093c-.218-.76-.54-1.187-1.208-1.187h-4.856l1.018 1.18h3.948l2.043 11.038h-7.193v2.728H9.114v-2.725h-7.36l2.66-11.04h3.33l1.018-1.18H3.907c-.668 0-1.06.46-1.21 1.186L0 16.456v7.062C0 24.338.676 25 1.51 25h23.98c.833 0 1.51-.663 1.51-1.482v-7.062L24.3 5.093z"/>\n  </svg>']),_templateObject7=_taggedTemplateLiteralLoose(['<svg class="UppyIcon" width="14px" height="14px" viewBox="0 0 19 19">\n    <polygon points="17.3182539 17.2324466 9.93955339 9.85374611 9.586 9.50019272 9.23244661 9.85374611 1.85374611 17.2324466 2.56085289 17.2324466 1.93955339 16.6111471 1.93955865 17.3182486 9.31803946 9.93954813 9.67158232 9.58599474 9.31803419 9.23244661 1.93955339 1.85396581 1.93961588 2.56101008 2.56091538 1.93949089 1.85375137 1.93955865 9.23245187 9.31803946 9.586 9.67157706 9.93954813 9.31803946 17.3182486 1.93955865 16.6111471 1.93955339 17.2324466 2.56085289 17.2324466 1.85374611 9.85374611 9.23244661 9.50019272 9.586 9.85374611 9.93955339 17.2324466 17.3182539 17.9395534 16.6111471 10.5608529 9.23244661 10.5608529 9.93955339 17.9395534 2.56085289 18.2931068 2.2072995 17.9395534 1.85374611 17.3182539 1.23244661 16.9647058 0.878898482 16.6111524 1.23244135 9.23245187 8.61092215 9.93954813 8.61092215 2.56084763 1.23244135 2.20723173 0.87883598 1.85368362 1.23250911 1.23238412 1.85402831 0.878955712 2.20758169 1.23244661 2.56107259 8.61092741 9.93955339 8.61092215 9.23245187 1.23244135 16.6111524 0.878898482 16.9647058 1.23244661 17.3182539 1.85374611 17.9395534 2.2072995 18.2931068 2.56085289 17.9395534 9.93955339 10.5608529 9.23244661 10.5608529 16.6111471 17.9395534"></polygon>\n  </svg>'],['<svg class="UppyIcon" width="14px" height="14px" viewBox="0 0 19 19">\n    <polygon points="17.3182539 17.2324466 9.93955339 9.85374611 9.586 9.50019272 9.23244661 9.85374611 1.85374611 17.2324466 2.56085289 17.2324466 1.93955339 16.6111471 1.93955865 17.3182486 9.31803946 9.93954813 9.67158232 9.58599474 9.31803419 9.23244661 1.93955339 1.85396581 1.93961588 2.56101008 2.56091538 1.93949089 1.85375137 1.93955865 9.23245187 9.31803946 9.586 9.67157706 9.93954813 9.31803946 17.3182486 1.93955865 16.6111471 1.93955339 17.2324466 2.56085289 17.2324466 1.85374611 9.85374611 9.23244661 9.50019272 9.586 9.85374611 9.93955339 17.2324466 17.3182539 17.9395534 16.6111471 10.5608529 9.23244661 10.5608529 9.93955339 17.9395534 2.56085289 18.2931068 2.2072995 17.9395534 1.85374611 17.3182539 1.23244661 16.9647058 0.878898482 16.6111524 1.23244135 9.23245187 8.61092215 9.93954813 8.61092215 2.56084763 1.23244135 2.20723173 0.87883598 1.85368362 1.23250911 1.23238412 1.85402831 0.878955712 2.20758169 1.23244661 2.56107259 8.61092741 9.93955339 8.61092215 9.23245187 1.23244135 16.6111524 0.878898482 16.9647058 1.23244661 17.3182539 1.85374611 17.9395534 2.2072995 18.2931068 2.56085289 17.9395534 9.93955339 10.5608529 9.23244661 10.5608529 16.6111471 17.9395534"></polygon>\n  </svg>']),_templateObject8=_taggedTemplateLiteralLoose(['<svg class="UppyIcon" width="16px" height="16px" viewBox="0 0 32 30">\n      <path d="M6.6209894,11.1451162 C6.6823051,11.2751669 6.81374248,11.3572188 6.95463813,11.3572188 L12.6925482,11.3572188 L12.6925482,16.0630427 C12.6925482,17.880509 14.1726048,18.75 16.0000083,18.75 C17.8261072,18.75 19.3074684,17.8801847 19.3074684,16.0630427 L19.3074684,11.3572188 L25.0437478,11.3572188 C25.1875787,11.3572188 25.3164069,11.2751669 25.3790272,11.1451162 C25.4370814,11.0173358 25.4171865,10.8642587 25.3252129,10.7562615 L16.278212,0.127131837 C16.2093949,0.0463771751 16.1069846,0 15.9996822,0 C15.8910751,0 15.7886648,0.0463771751 15.718217,0.127131837 L6.6761083,10.7559371 C6.58250402,10.8642587 6.56293518,11.0173358 6.6209894,11.1451162 L6.6209894,11.1451162 Z"/>\n      <path d="M28.8008722,6.11142645 C28.5417891,5.19831555 28.1583331,4.6875 27.3684848,4.6875 L21.6124454,4.6875 L22.8190234,6.10307874 L27.4986725,6.10307874 L29.9195817,19.3486449 L21.3943891,19.3502502 L21.3943891,22.622552 L10.8023461,22.622552 L10.8023461,19.3524977 L2.07815702,19.3534609 L5.22979699,6.10307874 L9.17871529,6.10307874 L10.3840011,4.6875 L4.6308691,4.6875 C3.83940559,4.6875 3.37421888,5.2390909 3.19815864,6.11142645 L0,19.7470874 L0,28.2212959 C0,29.2043992 0.801477937,30 1.78870751,30 L30.2096773,30 C31.198199,30 32,29.2043992 32,28.2212959 L32,19.7470874 L28.8008722,6.11142645 L28.8008722,6.11142645 Z"/>\n    </svg>'],['<svg class="UppyIcon" width="16px" height="16px" viewBox="0 0 32 30">\n      <path d="M6.6209894,11.1451162 C6.6823051,11.2751669 6.81374248,11.3572188 6.95463813,11.3572188 L12.6925482,11.3572188 L12.6925482,16.0630427 C12.6925482,17.880509 14.1726048,18.75 16.0000083,18.75 C17.8261072,18.75 19.3074684,17.8801847 19.3074684,16.0630427 L19.3074684,11.3572188 L25.0437478,11.3572188 C25.1875787,11.3572188 25.3164069,11.2751669 25.3790272,11.1451162 C25.4370814,11.0173358 25.4171865,10.8642587 25.3252129,10.7562615 L16.278212,0.127131837 C16.2093949,0.0463771751 16.1069846,0 15.9996822,0 C15.8910751,0 15.7886648,0.0463771751 15.718217,0.127131837 L6.6761083,10.7559371 C6.58250402,10.8642587 6.56293518,11.0173358 6.6209894,11.1451162 L6.6209894,11.1451162 Z"/>\n      <path d="M28.8008722,6.11142645 C28.5417891,5.19831555 28.1583331,4.6875 27.3684848,4.6875 L21.6124454,4.6875 L22.8190234,6.10307874 L27.4986725,6.10307874 L29.9195817,19.3486449 L21.3943891,19.3502502 L21.3943891,22.622552 L10.8023461,22.622552 L10.8023461,19.3524977 L2.07815702,19.3534609 L5.22979699,6.10307874 L9.17871529,6.10307874 L10.3840011,4.6875 L4.6308691,4.6875 C3.83940559,4.6875 3.37421888,5.2390909 3.19815864,6.11142645 L0,19.7470874 L0,28.2212959 C0,29.2043992 0.801477937,30 1.78870751,30 L30.2096773,30 C31.198199,30 32,29.2043992 32,28.2212959 L32,19.7470874 L28.8008722,6.11142645 L28.8008722,6.11142645 Z"/>\n    </svg>']),_templateObject9=_taggedTemplateLiteralLoose(['<svg class="UppyIcon UppyIcon-check" width="13px" height="9px" viewBox="0 0 13 9">\n    <polygon points="5 7.293 1.354 3.647 0.646 4.354 5 8.707 12.354 1.354 11.646 0.647"></polygon>\n  </svg>'],['<svg class="UppyIcon UppyIcon-check" width="13px" height="9px" viewBox="0 0 13 9">\n    <polygon points="5 7.293 1.354 3.647 0.646 4.354 5 8.707 12.354 1.354 11.646 0.647"></polygon>\n  </svg>']),_templateObject10=_taggedTemplateLiteralLoose(['<svg class="UppyIcon" width="34" height="91" viewBox="0 0 34 91">\n    <path d="M22.366 43.134V29.33c5.892-6.588 10.986-14.507 10.986-22.183 0-4.114-2.986-7.1-7.1-7.1-3.914 0-7.1 3.186-7.1 7.1v20.936a92.562 92.562 0 0 1-5.728 5.677l-.384.348C4.643 41.762.428 45.604.428 54.802c0 8.866 7.214 16.08 16.08 16.08.902 0 1.784-.074 2.644-.216v11.26c0 2.702-2.198 4.9-4.9 4.9a4.855 4.855 0 0 1-2.95-1.015c2.364-.24 4.222-2.218 4.222-4.643a4.698 4.698 0 0 0-4.692-4.692 4.738 4.738 0 0 0-4.213 2.628c-.923 1.874-.56 4.386.277 6.228a7.82 7.82 0 0 0 .9 1.502 8.178 8.178 0 0 0 4.23 2.896c.723.207 1.474.31 2.226.31 4.474 0 8.113-3.64 8.113-8.113V69.78c5.98-2.345 10.225-8.176 10.225-14.977 0-5.975-4.464-10.876-10.224-11.67zm0-35.987a3.89 3.89 0 0 1 3.887-3.885c1.933 0 3.885 1.202 3.885 3.885 0 4.95-2.702 10.862-7.772 17.204V7.148zM16.51 67.67c-7.096 0-12.867-5.77-12.867-12.867 0-7.78 3.385-10.865 11.563-18.32l.384-.35c1.166-1.064 2.365-2.2 3.562-3.402v10.404c-5.758.793-10.223 5.695-10.223 11.67 0 3.935 1.948 7.603 5.212 9.81a1.605 1.605 0 1 0 1.8-2.66 8.622 8.622 0 0 1-3.8-7.15c0-4.2 3.025-7.7 7.01-8.456v21.05c-.853.178-1.736.272-2.642.272zm5.856-1.412v-19.91c3.985.756 7.01 4.253 7.01 8.455 0 4.987-2.85 9.32-7.01 11.455z" />\n  </svg>'],['<svg class="UppyIcon" width="34" height="91" viewBox="0 0 34 91">\n    <path d="M22.366 43.134V29.33c5.892-6.588 10.986-14.507 10.986-22.183 0-4.114-2.986-7.1-7.1-7.1-3.914 0-7.1 3.186-7.1 7.1v20.936a92.562 92.562 0 0 1-5.728 5.677l-.384.348C4.643 41.762.428 45.604.428 54.802c0 8.866 7.214 16.08 16.08 16.08.902 0 1.784-.074 2.644-.216v11.26c0 2.702-2.198 4.9-4.9 4.9a4.855 4.855 0 0 1-2.95-1.015c2.364-.24 4.222-2.218 4.222-4.643a4.698 4.698 0 0 0-4.692-4.692 4.738 4.738 0 0 0-4.213 2.628c-.923 1.874-.56 4.386.277 6.228a7.82 7.82 0 0 0 .9 1.502 8.178 8.178 0 0 0 4.23 2.896c.723.207 1.474.31 2.226.31 4.474 0 8.113-3.64 8.113-8.113V69.78c5.98-2.345 10.225-8.176 10.225-14.977 0-5.975-4.464-10.876-10.224-11.67zm0-35.987a3.89 3.89 0 0 1 3.887-3.885c1.933 0 3.885 1.202 3.885 3.885 0 4.95-2.702 10.862-7.772 17.204V7.148zM16.51 67.67c-7.096 0-12.867-5.77-12.867-12.867 0-7.78 3.385-10.865 11.563-18.32l.384-.35c1.166-1.064 2.365-2.2 3.562-3.402v10.404c-5.758.793-10.223 5.695-10.223 11.67 0 3.935 1.948 7.603 5.212 9.81a1.605 1.605 0 1 0 1.8-2.66 8.622 8.622 0 0 1-3.8-7.15c0-4.2 3.025-7.7 7.01-8.456v21.05c-.853.178-1.736.272-2.642.272zm5.856-1.412v-19.91c3.985.756 7.01 4.253 7.01 8.455 0 4.987-2.85 9.32-7.01 11.455z" />\n  </svg>']),_templateObject11=_taggedTemplateLiteralLoose(['<svg class="UppyIcon" width="44" height="58" viewBox="0 0 44 58">\n    <path d="M27.437.517a1 1 0 0 0-.094.03H4.25C2.037.548.217 2.368.217 4.58v48.405c0 2.212 1.82 4.03 4.03 4.03H39.03c2.21 0 4.03-1.818 4.03-4.03V15.61a1 1 0 0 0-.03-.28 1 1 0 0 0 0-.093 1 1 0 0 0-.03-.032 1 1 0 0 0 0-.03 1 1 0 0 0-.032-.063 1 1 0 0 0-.03-.063 1 1 0 0 0-.032 0 1 1 0 0 0-.03-.063 1 1 0 0 0-.032-.03 1 1 0 0 0-.03-.063 1 1 0 0 0-.063-.062l-14.593-14a1 1 0 0 0-.062-.062A1 1 0 0 0 28 .708a1 1 0 0 0-.374-.157 1 1 0 0 0-.156 0 1 1 0 0 0-.03-.03l-.003-.003zM4.25 2.547h22.218v9.97c0 2.21 1.82 4.03 4.03 4.03h10.564v36.438a2.02 2.02 0 0 1-2.032 2.032H4.25c-1.13 0-2.032-.9-2.032-2.032V4.58c0-1.13.902-2.032 2.03-2.032zm24.218 1.345l10.375 9.937.75.718H30.5c-1.13 0-2.032-.9-2.032-2.03V3.89z" />\n  </svg>'],['<svg class="UppyIcon" width="44" height="58" viewBox="0 0 44 58">\n    <path d="M27.437.517a1 1 0 0 0-.094.03H4.25C2.037.548.217 2.368.217 4.58v48.405c0 2.212 1.82 4.03 4.03 4.03H39.03c2.21 0 4.03-1.818 4.03-4.03V15.61a1 1 0 0 0-.03-.28 1 1 0 0 0 0-.093 1 1 0 0 0-.03-.032 1 1 0 0 0 0-.03 1 1 0 0 0-.032-.063 1 1 0 0 0-.03-.063 1 1 0 0 0-.032 0 1 1 0 0 0-.03-.063 1 1 0 0 0-.032-.03 1 1 0 0 0-.03-.063 1 1 0 0 0-.063-.062l-14.593-14a1 1 0 0 0-.062-.062A1 1 0 0 0 28 .708a1 1 0 0 0-.374-.157 1 1 0 0 0-.156 0 1 1 0 0 0-.03-.03l-.003-.003zM4.25 2.547h22.218v9.97c0 2.21 1.82 4.03 4.03 4.03h10.564v36.438a2.02 2.02 0 0 1-2.032 2.032H4.25c-1.13 0-2.032-.9-2.032-2.032V4.58c0-1.13.902-2.032 2.03-2.032zm24.218 1.345l10.375 9.937.75.718H30.5c-1.13 0-2.032-.9-2.032-2.03V3.89z" />\n  </svg>']),_templateObject12=_taggedTemplateLiteralLoose(['<svg class="UppyIcon" width="50" height="63" viewBox="0 0 50 63">\n    <path d="M0 .5v15.617h6.25l1.7-5.1a6.242 6.242 0 0 1 5.933-4.267h8V50.5c0 3.45-2.8 6.25-6.25 6.25H12.5V63h25v-6.25h-3.133c-3.45 0-6.25-2.8-6.25-6.25V6.75h8a6.257 6.257 0 0 1 5.933 4.267l1.7 5.1H50V.5H0z" />\n  </svg>'],['<svg class="UppyIcon" width="50" height="63" viewBox="0 0 50 63">\n    <path d="M0 .5v15.617h6.25l1.7-5.1a6.242 6.242 0 0 1 5.933-4.267h8V50.5c0 3.45-2.8 6.25-6.25 6.25H12.5V63h25v-6.25h-3.133c-3.45 0-6.25-2.8-6.25-6.25V6.75h8a6.257 6.257 0 0 1 5.933 4.267l1.7 5.1H50V.5H0z" />\n  </svg>']),_templateObject13=_taggedTemplateLiteralLoose(['<svg width="22" height="21" viewBox="0 0 18 17">\n    <ellipse fill="#000" cx="8.62" cy="8.383" rx="8.62" ry="8.383"/>\n    <path stroke="#FFF" fill="#FFF" d="M11 6.147L10.85 6 8.5 8.284 6.15 6 6 6.147 8.35 8.43 6 10.717l.15.146L8.5 8.578l2.35 2.284.15-.146L8.65 8.43z"/>\n  </svg>'],['<svg width="22" height="21" viewBox="0 0 18 17">\n    <ellipse fill="#000" cx="8.62" cy="8.383" rx="8.62" ry="8.383"/>\n    <path stroke="#FFF" fill="#FFF" d="M11 6.147L10.85 6 8.5 8.284 6.15 6 6 6.147 8.35 8.43 6 10.717l.15.146L8.5 8.578l2.35 2.284.15-.146L8.65 8.43z"/>\n  </svg>']),_templateObject14=_taggedTemplateLiteralLoose(['<svg class="UppyIcon" width="37" height="33" viewBox="0 0 37 33">\n    <path d="M29.107 24.5c4.07 0 7.393-3.355 7.393-7.442 0-3.994-3.105-7.307-7.012-7.502l.468.415C29.02 4.52 24.34.5 18.886.5c-4.348 0-8.27 2.522-10.138 6.506l.446-.288C4.394 6.782.5 10.758.5 15.608c0 4.924 3.906 8.892 8.76 8.892h4.872c.635 0 1.095-.467 1.095-1.104 0-.636-.46-1.103-1.095-1.103H9.26c-3.644 0-6.63-3.035-6.63-6.744 0-3.71 2.926-6.685 6.57-6.685h.964l.14-.28.177-.362c1.477-3.4 4.744-5.576 8.347-5.576 4.58 0 8.45 3.452 9.01 8.072l.06.536.05.446h1.101c2.87 0 5.204 2.37 5.204 5.295s-2.333 5.296-5.204 5.296h-6.062c-.634 0-1.094.467-1.094 1.103 0 .637.46 1.104 1.094 1.104h6.12z"/>\n    <path d="M23.196 18.92l-4.828-5.258-.366-.4-.368.398-4.828 5.196a1.13 1.13 0 0 0 0 1.546c.428.46 1.11.46 1.537 0l3.45-3.71-.868-.34v15.03c0 .64.445 1.118 1.075 1.118.63 0 1.075-.48 1.075-1.12V16.35l-.867.34 3.45 3.712a1 1 0 0 0 .767.345 1 1 0 0 0 .77-.345c.416-.33.416-1.036 0-1.485v.003z"/>\n  </svg>'],['<svg class="UppyIcon" width="37" height="33" viewBox="0 0 37 33">\n    <path d="M29.107 24.5c4.07 0 7.393-3.355 7.393-7.442 0-3.994-3.105-7.307-7.012-7.502l.468.415C29.02 4.52 24.34.5 18.886.5c-4.348 0-8.27 2.522-10.138 6.506l.446-.288C4.394 6.782.5 10.758.5 15.608c0 4.924 3.906 8.892 8.76 8.892h4.872c.635 0 1.095-.467 1.095-1.104 0-.636-.46-1.103-1.095-1.103H9.26c-3.644 0-6.63-3.035-6.63-6.744 0-3.71 2.926-6.685 6.57-6.685h.964l.14-.28.177-.362c1.477-3.4 4.744-5.576 8.347-5.576 4.58 0 8.45 3.452 9.01 8.072l.06.536.05.446h1.101c2.87 0 5.204 2.37 5.204 5.295s-2.333 5.296-5.204 5.296h-6.062c-.634 0-1.094.467-1.094 1.103 0 .637.46 1.104 1.094 1.104h6.12z"/>\n    <path d="M23.196 18.92l-4.828-5.258-.366-.4-.368.398-4.828 5.196a1.13 1.13 0 0 0 0 1.546c.428.46 1.11.46 1.537 0l3.45-3.71-.868-.34v15.03c0 .64.445 1.118 1.075 1.118.63 0 1.075-.48 1.075-1.12V16.35l-.867.34 3.45 3.712a1 1 0 0 0 .767.345 1 1 0 0 0 .77-.345c.416-.33.416-1.036 0-1.485v.003z"/>\n  </svg>']),_templateObject15=_taggedTemplateLiteralLoose(['<svg class="UppyIcon" width="102" height="124" viewBox="0 0 102 124">\n    <g>\n      <path d="M69.125 124c7.363 0 13.353-5.975 13.353-13.322v-6.15h4c8.56 0 15.522-6.946 15.522-15.482v-59.16c0-2.033-1.087-4.65-2.53-6.088L78.14 2.52C76.7 1.085 74.075 0 72.038 0H32.873c-7.36 0-13.35 6.947-13.35 15.483v3.99h-6.168C5.99 19.472 0 25.445 0 32.792v77.885C0 118.025 5.99 124 13.355 124h55.77zM76.903 7.488l17.59 17.55h-13.13c-2.46 0-4.46-2-4.46-4.454V7.488zm-52.985 7.995c0-6.12 4.016-11.1 8.955-11.1h39.165c.14 0 .3.022.466.05v16.15c0 4.873 3.973 8.837 8.86 8.837h16.19c.028.165.048.323.048.467v59.158c0 6.118-4.99 11.097-11.125 11.097H35.043c-6.135 0-11.127-4.978-11.127-11.096V15.483h.002zm-19.52 95.195V32.792c0-4.928 4.018-8.934 8.957-8.934h6.167v65.188c0 8.536 6.963 15.482 15.52 15.482H78.08v6.15c0 4.927-4.017 8.935-8.955 8.935h-55.77c-4.94 0-8.957-4.008-8.957-8.935z"/><path d="M40.218 76h40.564C82.007 76 83 75.106 83 74c0-1.106-.993-2-2.218-2H40.218C38.995 72 38 72.894 38 74c0 1.106.995 2 2.218 2zM40.218 57h40.564C82.007 57 83 56.105 83 55c0-1.106-.993-2-2.218-2H40.218C38.995 53 38 53.894 38 55c0 1.105.995 2 2.218 2zM40.208 37h23.584c1.22 0 2.208-.896 2.208-2s-.987-2-2.208-2H40.208C38.99 33 38 33.896 38 35s.99 2 2.208 2z"/>\n    </g>\n  </svg>'],['<svg class="UppyIcon" width="102" height="124" viewBox="0 0 102 124">\n    <g>\n      <path d="M69.125 124c7.363 0 13.353-5.975 13.353-13.322v-6.15h4c8.56 0 15.522-6.946 15.522-15.482v-59.16c0-2.033-1.087-4.65-2.53-6.088L78.14 2.52C76.7 1.085 74.075 0 72.038 0H32.873c-7.36 0-13.35 6.947-13.35 15.483v3.99h-6.168C5.99 19.472 0 25.445 0 32.792v77.885C0 118.025 5.99 124 13.355 124h55.77zM76.903 7.488l17.59 17.55h-13.13c-2.46 0-4.46-2-4.46-4.454V7.488zm-52.985 7.995c0-6.12 4.016-11.1 8.955-11.1h39.165c.14 0 .3.022.466.05v16.15c0 4.873 3.973 8.837 8.86 8.837h16.19c.028.165.048.323.048.467v59.158c0 6.118-4.99 11.097-11.125 11.097H35.043c-6.135 0-11.127-4.978-11.127-11.096V15.483h.002zm-19.52 95.195V32.792c0-4.928 4.018-8.934 8.957-8.934h6.167v65.188c0 8.536 6.963 15.482 15.52 15.482H78.08v6.15c0 4.927-4.017 8.935-8.955 8.935h-55.77c-4.94 0-8.957-4.008-8.957-8.935z"/><path d="M40.218 76h40.564C82.007 76 83 75.106 83 74c0-1.106-.993-2-2.218-2H40.218C38.995 72 38 72.894 38 74c0 1.106.995 2 2.218 2zM40.218 57h40.564C82.007 57 83 56.105 83 55c0-1.106-.993-2-2.218-2H40.218C38.995 53 38 53.894 38 55c0 1.105.995 2 2.218 2zM40.208 37h23.584c1.22 0 2.208-.896 2.208-2s-.987-2-2.208-2H40.208C38.99 33 38 33.896 38 35s.99 2 2.208 2z"/>\n    </g>\n  </svg>']);exports.defaultTabIcon=defaultTabIcon,exports.iconCopy=iconCopy,exports.iconResume=iconResume,exports.iconPause=iconPause,exports.iconEdit=iconEdit,exports.localIcon=localIcon,exports.closeIcon=closeIcon,exports.pluginIcon=pluginIcon,exports.checkIcon=checkIcon,exports.iconAudio=iconAudio,exports.iconFile=iconFile,exports.iconText=iconText,exports.removeIcon=removeIcon,exports.uploadIcon=uploadIcon,exports.dashboardBgIcon=dashboardBgIcon;var _html=require("../../core/html"),_html2=_interopRequireDefault(_html);
},{"../../core/html":36}],50:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}exports.__esModule=!0;var _extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var o in r)Object.prototype.hasOwnProperty.call(r,o)&&(e[o]=r[o])}return e},_Plugin2=require("../Plugin"),_Plugin3=_interopRequireDefault(_Plugin2),_dragDrop=require("drag-drop"),_dragDrop2=_interopRequireDefault(_dragDrop),_Dashboard=require("./Dashboard"),_Dashboard2=_interopRequireDefault(_Dashboard),_Utils=require("../../core/Utils"),_prettyBytes=require("pretty-bytes"),_prettyBytes2=_interopRequireDefault(_prettyBytes),_icons=require("./icons"),DashboardUI=function(e){function t(r,o){_classCallCheck(this,t);var i=_possibleConstructorReturn(this,e.call(this,r,o));i.id="DashboardUI",i.title="Dashboard UI",i.type="orchestrator";var s={target:"body",inline:!1,semiTransparent:!1,defaultTabIcon:(0,_icons.defaultTabIcon)(),panelSelectorPrefix:"UppyDashboardContent-panel",showProgressDetails:!0};return i.opts=_extends({},s,o),i.hideModal=i.hideModal.bind(i),i.showModal=i.showModal.bind(i),i.addTarget=i.addTarget.bind(i),i.actions=i.actions.bind(i),i.hideAllPanels=i.hideAllPanels.bind(i),i.showPanel=i.showPanel.bind(i),i.initEvents=i.initEvents.bind(i),i.handleDrop=i.handleDrop.bind(i),i.pauseAll=i.pauseAll.bind(i),i.resumeAll=i.resumeAll.bind(i),i.render=i.render.bind(i),i.install=i.install.bind(i),i}return _inherits(t,e),t.prototype.addTarget=function(e){var t=e.constructor.name,r=e.title||t,o=e.icon||this.opts.defaultTabIcon,i=e.type;if("acquirer"!==i&&"progressindicator"!==i&&"presenter"!==i){var s="Error: Modal can only be used by plugins of types: acquirer, progressindicator, presenter";return void this.core.log(s)}var n={id:t,name:r,icon:o,type:i,focus:e.focus,render:e.render,isHidden:!0},a=this.core.getState().modal,l=a.targets.slice();return l.push(n),this.core.setState({modal:_extends({},a,{targets:l})}),this.opts.target},t.prototype.hideAllPanels=function(){var e=this.core.getState().modal,t=e.targets.map(function(e){return _extends({},e,{isHidden:!0})});this.core.setState({modal:_extends({},e,{targets:t})})},t.prototype.showPanel=function(e){var t=this.core.getState().modal,r=t.targets.map(function(t){return"acquirer"===t.type?t.id===e?(t.focus(),_extends({},t,{isHidden:!1})):_extends({},t,{isHidden:!0}):t});this.core.setState({modal:_extends({},t,{targets:r})})},t.prototype.hideModal=function(){var e=this.core.getState().modal;this.core.setState({modal:_extends({},e,{isHidden:!0})}),document.body.classList.remove("is-UppyDashboard-open")},t.prototype.showModal=function(){var e=this.core.getState().modal;this.core.setState({modal:_extends({},e,{isHidden:!1})}),document.body.classList.add("is-UppyDashboard-open"),document.querySelector(".UppyDashboard-inner").focus()},t.prototype.initEvents=function(){var e=this,t=document.querySelector(this.opts.trigger);t.addEventListener("click",this.showModal),document.body.addEventListener("keyup",function(t){27===t.keyCode&&e.hideModal()}),(0,_dragDrop2.default)(this.el,function(t){e.handleDrop(t)})},t.prototype.actions=function(){var e=this,t=this.core.bus;t.on("core:file-add",function(){e.hideAllPanels()}),t.on("dashboard:file-card",function(t){var r=e.core.getState().modal;e.core.setState({modal:_extends({},r,{fileCardFor:t||!1})})}),t.on("core:success",function(r){t.emit("informer",e.core.i18n("files",{smart_count:r})+" successfully uploaded, Sir!","info",6e3)})},t.prototype.handleDrop=function(e){var t=this;this.core.log("All right, someone dropped something..."),e.forEach(function(e){t.core.bus.emit("core:file-add",{source:t.id,name:e.name,type:e.type,data:e})})},t.prototype.pauseAll=function(){this.core.bus.emit("core:pause-all")},t.prototype.resumeAll=function(){this.core.bus.emit("core:resume-all")},t.prototype.getTotalSpeed=function(e){var t=0;return e.forEach(function(e){t+=(0,_Utils.getSpeed)(e.progress)}),t},t.prototype.getTotalETA=function(e){var t=0;return e.forEach(function(e){t+=(0,_Utils.getETA)(e.progress)}),t},t.prototype.render=function(e){var t=this,r=e.files,o=Object.keys(r).filter(function(e){return!r[e].progress.uploadStarted}),i=Object.keys(r).filter(function(e){return r[e].progress.uploadStarted}),s=Object.keys(r).filter(function(e){return r[e].progress.uploadComplete}),n=Object.keys(r).filter(function(e){return!r[e].progress.uploadComplete&&r[e].progress.uploadStarted&&!r[e].isPaused}),a=[];n.forEach(function(e){a.push(r[e])});var l=(0,_prettyBytes2.default)(this.getTotalSpeed(a)),d=(0,_Utils.prettyETA)(this.getTotalETA(a)),c=100===e.totalProgress,u=0===n.length&&!c,p=e.modal.targets.filter(function(e){return"acquirer"===e.type}),h=e.modal.targets.filter(function(e){return"progressindicator"===e.type}),f=function(e){t.core.emitter.emit("core:file-add",e)},m=function(e){t.core.emitter.emit("core:file-remove",e)},g=function(e){t.core.emitter.emit("core:upload")},y=function(e){t.core.emitter.emit("core:upload-pause",e)},b=function(e){t.core.emitter.emit("dashboard:file-card",e)},_=function(e,r){t.core.emitter.emit("core:update-meta",e,r),t.core.emitter.emit("dashboard:file-card")},P=function(e,r,o){t.core.emitter.emit("informer",e,r,o)};return(0,_Dashboard2.default)({state:e,modal:e.modal,newFiles:o,files:r,totalFileCount:Object.keys(r).length,uploadStartedFiles:i,completeFiles:s,inProgressFiles:n,totalSpeed:l,totalETA:d,totalProgress:e.totalProgress,isAllComplete:c,isAllPaused:u,acquirers:p,progressindicators:h,autoProceed:this.core.opts.autoProceed,id:this.id,container:this.opts.target,hideModal:this.hideModal,panelSelectorPrefix:this.opts.panelSelectorPrefix,showProgressDetails:this.opts.showProgressDetails,inline:this.opts.inline,semiTransparent:this.opts.semiTransparent,onPaste:this.handlePaste,showPanel:this.showPanel,hideAllPanels:this.hideAllPanels,log:this.core.log,bus:this.core.emitter,i18n:this.core.i18n,pauseAll:this.pauseAll,resumeAll:this.resumeAll,addFile:f,removeFile:m,info:P,metaFields:e.metaFields,startUpload:g,pauseUpload:y,fileCardFor:e.modal.fileCardFor,showFileCard:b,fileCardDone:_})},t.prototype.install=function(){this.core.setState({modal:{isHidden:!0,showFileCard:!1,targets:[]}});var e=this.opts.target,t=this;this.target=this.mount(e,t),this.initEvents(),this.actions()},t}(_Plugin3.default);exports.default=DashboardUI;
},{"../../core/Utils":35,"../Plugin":66,"./Dashboard":40,"./icons":49,"drag-drop":4,"pretty-bytes":12}],51:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _taggedTemplateLiteralLoose(t,e){return t.raw=e,t}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}exports.__esModule=!0;var _extends=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var r=arguments[e];for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(t[n]=r[n])}return t},_templateObject=_taggedTemplateLiteralLoose(['\n      <svg class="UppyIcon" width="28" height="28" viewBox="0 0 16 16">\n        <path d="M15.982 2.97c0-.02 0-.02-.018-.037 0-.017-.017-.035-.035-.053 0 0 0-.018-.02-.018-.017-.018-.034-.053-.052-.07L13.19.123c-.017-.017-.034-.035-.07-.053h-.018c-.018-.017-.035-.017-.053-.034h-.02c-.017 0-.034-.018-.052-.018h-6.31a.415.415 0 0 0-.446.426V11.11c0 .25.196.446.445.446h8.89A.44.44 0 0 0 16 11.11V3.023c-.018-.018-.018-.035-.018-.053zm-2.65-1.46l1.157 1.157h-1.157V1.51zm1.78 9.157h-8V.89h5.332v2.22c0 .25.196.446.445.446h2.22v7.11z"/>\n        <path d="M9.778 12.89H4V2.666a.44.44 0 0 0-.444-.445.44.44 0 0 0-.445.445v10.666c0 .25.197.445.446.445h6.222a.44.44 0 0 0 .444-.445.44.44 0 0 0-.444-.444z"/>\n        <path d="M.444 16h6.223a.44.44 0 0 0 .444-.444.44.44 0 0 0-.443-.445H.89V4.89a.44.44 0 0 0-.446-.446A.44.44 0 0 0 0 4.89v10.666c0 .248.196.444.444.444z"/>\n      </svg>\n    '],['\n      <svg class="UppyIcon" width="28" height="28" viewBox="0 0 16 16">\n        <path d="M15.982 2.97c0-.02 0-.02-.018-.037 0-.017-.017-.035-.035-.053 0 0 0-.018-.02-.018-.017-.018-.034-.053-.052-.07L13.19.123c-.017-.017-.034-.035-.07-.053h-.018c-.018-.017-.035-.017-.053-.034h-.02c-.017 0-.034-.018-.052-.018h-6.31a.415.415 0 0 0-.446.426V11.11c0 .25.196.446.445.446h8.89A.44.44 0 0 0 16 11.11V3.023c-.018-.018-.018-.035-.018-.053zm-2.65-1.46l1.157 1.157h-1.157V1.51zm1.78 9.157h-8V.89h5.332v2.22c0 .25.196.446.445.446h2.22v7.11z"/>\n        <path d="M9.778 12.89H4V2.666a.44.44 0 0 0-.444-.445.44.44 0 0 0-.445.445v10.666c0 .25.197.445.446.445h6.222a.44.44 0 0 0 .444-.445.44.44 0 0 0-.444-.444z"/>\n        <path d="M.444 16h6.223a.44.44 0 0 0 .444-.444.44.44 0 0 0-.443-.445H.89V4.89a.44.44 0 0 0-.446-.446A.44.44 0 0 0 0 4.89v10.666c0 .248.196.444.444.444z"/>\n      </svg>\n    ']),_templateObject2=_taggedTemplateLiteralLoose(['\n      <div class="UppyDragDrop-container ','">\n        <form class="UppyDragDrop-inner"\n              onsubmit=','>\n          <input class="UppyDragDrop-input UppyDragDrop-focus"\n                 type="file"\n                 name="files[]"\n                 multiple="true"\n                 value=""\n                 onchange=',' />\n          <label class="UppyDragDrop-label" onclick=',">\n            <strong>",'</strong>\n            <span class="UppyDragDrop-dragText">',"</span>\n          </label>\n          ","\n        </form>\n      </div>\n    "],['\n      <div class="UppyDragDrop-container ','">\n        <form class="UppyDragDrop-inner"\n              onsubmit=','>\n          <input class="UppyDragDrop-input UppyDragDrop-focus"\n                 type="file"\n                 name="files[]"\n                 multiple="true"\n                 value=""\n                 onchange=',' />\n          <label class="UppyDragDrop-label" onclick=',">\n            <strong>",'</strong>\n            <span class="UppyDragDrop-dragText">',"</span>\n          </label>\n          ","\n        </form>\n      </div>\n    "]),_templateObject3=_taggedTemplateLiteralLoose(['<button class="UppyDragDrop-uploadBtn UppyNextBtn"\n                         type="submit"\n                         onclick=',">\n                    ","\n              </button>"],['<button class="UppyDragDrop-uploadBtn UppyNextBtn"\n                         type="submit"\n                         onclick=',">\n                    ","\n              </button>"]),_Plugin2=require("./../Plugin"),_Plugin3=_interopRequireDefault(_Plugin2),_Utils=require("../../core/Utils"),_dragDrop=require("drag-drop"),_dragDrop2=_interopRequireDefault(_dragDrop),_html=require("../../core/html"),_html2=_interopRequireDefault(_html),DragDrop=function(t){function e(r,n,o){_classCallCheck(this,e);var a=_possibleConstructorReturn(this,t.call(this,r,n));a.type="acquirer",a.id="DragDrop",a.title="Drag & Drop",a.props=o,a.icon=(0,_html2.default)(_templateObject);var p={target:".UppyDragDrop"};return a.opts=_extends({},p,n),a.isDragDropSupported=a.checkDragDropSupport(),a.handleDrop=a.handleDrop.bind(a),a.checkDragDropSupport=a.checkDragDropSupport.bind(a),a.handleInputChange=a.handleInputChange.bind(a),a.render=a.render.bind(a),a}return _inherits(e,t),e.prototype.checkDragDropSupport=function(){var t=document.createElement("div");return"draggable"in t&&"ondragstart"in t&&"ondrop"in t&&("FormData"in window&&"FileReader"in window)},e.prototype.handleDrop=function(t){var e=this;this.core.log("All right, someone dropped something..."),t.forEach(function(t){e.props.addFile({source:e.id,name:t.name,type:t.type,data:t})})},e.prototype.handleInputChange=function(t){var e=this;this.core.log("All right, something selected through input...");var r=(0,_Utils.toArray)(t.target.files);r.forEach(function(t){e.core.emitter.emit("core:file-add",{source:e.id,name:t.name,type:t.type,data:t})})},e.prototype.focus=function(){var t=document.querySelector(this.target+" .UppyDragDrop-focus");setTimeout(function(){t.focus()},10)},e.prototype.render=function(t){var e=this,r=this.opts.target.name,n=function(t){var r=document.querySelector(e.target+" .UppyDragDrop-input");r.click()},o=function(t){t.preventDefault(),t.stopPropagation(),e.core.emitter.emit("core:upload")},a=function(t){t.preventDefault()};return(0,_html2.default)(_templateObject2,this.isDragDropSupported?"is-dragdrop-supported":"",a,this.handleInputChange.bind(this),n,this.core.i18n("chooseFile"),this.core.i18n("orDragDrop"),this.core.opts.autoProceed||"Dashboard"===r?"":(0,_html2.default)(_templateObject3,o,this.core.i18n("upload")))},e.prototype.install=function(){var t=this,e=this.opts.target,r=this;this.target=this.mount(e,r),(0,_dragDrop2.default)(this.target+" .UppyDragDrop-container",function(e){t.handleDrop(e),t.core.log(e)})},e}(_Plugin3.default);exports.default=DragDrop;
},{"../../core/Utils":35,"../../core/html":36,"./../Plugin":66,"drag-drop":4}],52:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _taggedTemplateLiteralLoose(t,e){return t.raw=e,t}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}exports.__esModule=!0;var _extends=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(t[r]=n[r])}return t},_templateObject=_taggedTemplateLiteralLoose(["<h1>this is strange 1</h1>"],["<h1>this is strange 1</h1>"]),_templateObject2=_taggedTemplateLiteralLoose(["<h2>this is strange 2</h2>"],["<h2>this is strange 2</h2>"]),_templateObject3=_taggedTemplateLiteralLoose(['\n      <div class="wow-this-works">\n        <input class="UppyDummy-firstInput" type="text" value="hello">\n        ',"\n        ","\n      </div>\n    "],['\n      <div class="wow-this-works">\n        <input class="UppyDummy-firstInput" type="text" value="hello">\n        ',"\n        ","\n      </div>\n    "]),_Plugin2=require("./Plugin"),_Plugin3=_interopRequireDefault(_Plugin2),_html=require("../core/html"),_html2=_interopRequireDefault(_html),Dummy=function(t){function e(n,r,i){_classCallCheck(this,e);var o=_possibleConstructorReturn(this,t.call(this,n,r));o.type="acquirer",o.id="Dummy",o.title="Mr. Plugin",o.props=i;var s={};return o.opts=_extends({},s,r),o.strange=(0,_html2.default)(_templateObject),o.render=o.render.bind(o),o.install=o.install.bind(o),o}return _inherits(e,t),e.prototype.addFakeFileJustToTest=function(){var t=new Blob(["data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMTIwIDEyMCI+CiAgPGNpcmNsZSBjeD0iNjAiIGN5PSI2MCIgcj0iNTAiLz4KPC9zdmc+Cg=="],{type:"image/svg+xml"}),e={source:"acceptance-test",name:"test-file",type:"image/svg+xml",data:t};this.props.log("Adding fake file blob"),this.props.addFile(e)},e.prototype.render=function(){var t=(0,_html2.default)(_templateObject2);return(0,_html2.default)(_templateObject3,this.strange,t)},e.prototype.focus=function(){var t=this,e=document.querySelector(this.target+" .UppyDummy-firstInput");setTimeout(function(){e.focus()},10),setTimeout(function(){t.core.emit("informer","Hello! I’m a test Informer message","info",4500),t.addFakeFileJustToTest()},1e3)},e.prototype.install=function(){var t=this.opts.target,e=this;this.target=this.mount(t,e)},e}(_Plugin3.default);exports.default=Dummy;
},{"../core/html":36,"./Plugin":66}],53:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _taggedTemplateLiteralLoose(t,e){return t.raw=e,t}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}exports.__esModule=!0;var _extends=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(t[r]=n[r])}return t},_templateObject=_taggedTemplateLiteralLoose(['<form class="UppyFormContainer">\n      <input class="UppyForm-input"\n             type="file"\n             name="files[]"\n             onchange=','\n             multiple="','"\n             value="">\n      ',"\n    </form>"],['<form class="UppyFormContainer">\n      <input class="UppyForm-input"\n             type="file"\n             name="files[]"\n             onchange=','\n             multiple="','"\n             value="">\n      ',"\n    </form>"]),_templateObject2=_taggedTemplateLiteralLoose(['<button class="UppyForm-uploadBtn UppyNextBtn"\n                     type="submit"\n                     onclick=',">\n              ","\n            </button>"],['<button class="UppyForm-uploadBtn UppyNextBtn"\n                     type="submit"\n                     onclick=',">\n              ","\n            </button>"]),_Plugin2=require("./Plugin"),_Plugin3=_interopRequireDefault(_Plugin2),_Utils=require("../core/Utils"),_Utils2=_interopRequireDefault(_Utils),_html=require("../core/html"),_html2=_interopRequireDefault(_html),Formtag=function(t){function e(n,r){_classCallCheck(this,e);var o=_possibleConstructorReturn(this,t.call(this,n,r));o.id="Formtag",o.title="Formtag",o.type="acquirer";var i={target:".UppyForm",replaceTargetContent:!0,multipleFiles:!0};return o.opts=_extends({},i,r),o.render=o.render.bind(o),o}return _inherits(e,t),e.prototype.handleInputChange=function(t){var e=this;this.core.log("All right, something selected through input...");var n=_Utils2.default.toArray(t.target.files);n.forEach(function(t){e.core.emitter.emit("core:file-add",{source:e.id,name:t.name,type:t.type,data:t})})},e.prototype.render=function(t){var e=this,n=function(t){t.preventDefault(),t.stopPropagation(),e.core.emitter.emit("core:upload")};return(0,_html2.default)(_templateObject,this.handleInputChange.bind(this),this.opts.multipleFiles?"true":"false",this.core.opts.autoProceed||"Modal"===this.opts.target.name?"":(0,_html2.default)(_templateObject2,n,this.core.i18n("upload")))},e.prototype.install=function(){var t=this.opts.target,e=this;this.target=this.mount(t,e)},e}(_Plugin3.default);exports.default=Formtag;
},{"../core/Utils":35,"../core/html":36,"./Plugin":66}],54:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,t){return e.raw=t,e}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(["<a onclick=",">Proceed with Demo Account</a>"],["<a onclick=",">Proceed with Demo Account</a>"]),_templateObject2=_taggedTemplateLiteralLoose(['\n    <div class="UppyGoogleDrive-authenticate">\n      <h1>You need to authenticate with Google before selecting files.</h1>\n      <a href=',">Authenticate</a>\n      ","\n    </div>\n  "],['\n    <div class="UppyGoogleDrive-authenticate">\n      <h1>You need to authenticate with Google before selecting files.</h1>\n      <a href=',">Authenticate</a>\n      ","\n    </div>\n  "]),_html=require("../../core/html"),_html2=_interopRequireDefault(_html);exports.default=function(e){var t=e.demo?(0,_html2.default)(_templateObject,e.handleDemoAuth):null;return(0,_html2.default)(_templateObject2,e.link,t)};
},{"../../core/html":36}],55:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,t){return e.raw=t,e}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(["\n    <div>\n      <span>\n        Something went wrong.  Probably our fault. ","\n      </span>\n    </div>\n  "],["\n    <div>\n      <span>\n        Something went wrong.  Probably our fault. ","\n      </span>\n    </div>\n  "]),_html=require("../../core/html"),_html2=_interopRequireDefault(_html);exports.default=function(e){return(0,_html2.default)(_templateObject,e.error)};
},{"../../core/html":36}],56:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,t){return e.raw=t,e}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}exports.__esModule=!0;var _extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var i in o)Object.prototype.hasOwnProperty.call(o,i)&&(e[i]=o[i])}return e},_templateObject=_taggedTemplateLiteralLoose(['\n      <svg class="UppyIcon UppyModalTab-icon" width="28" height="28" viewBox="0 0 16 16">\n        <path d="M2.955 14.93l2.667-4.62H16l-2.667 4.62H2.955zm2.378-4.62l-2.666 4.62L0 10.31l5.19-8.99 2.666 4.62-2.523 4.37zm10.523-.25h-5.333l-5.19-8.99h5.334l5.19 8.99z"/>\n      </svg>\n    '],['\n      <svg class="UppyIcon UppyModalTab-icon" width="28" height="28" viewBox="0 0 16 16">\n        <path d="M2.955 14.93l2.667-4.62H16l-2.667 4.62H2.955zm2.378-4.62l-2.666 4.62L0 10.31l5.19-8.99 2.666 4.62-2.523 4.37zm10.523-.25h-5.333l-5.19-8.99h5.334l5.19 8.99z"/>\n      </svg>\n    ']),_Utils=require("../../core/Utils"),_Utils2=_interopRequireDefault(_Utils),_Plugin2=require("../Plugin"),_Plugin3=_interopRequireDefault(_Plugin2);require("whatwg-fetch");var _html=require("../../core/html"),_html2=_interopRequireDefault(_html),_Provider=require("../../uppy-base/src/plugins/Provider"),_Provider2=_interopRequireDefault(_Provider),_AuthView=require("./AuthView"),_AuthView2=_interopRequireDefault(_AuthView),_Browser=require("./new/Browser"),_Browser2=_interopRequireDefault(_Browser),_Error=require("./Error"),_Error2=_interopRequireDefault(_Error),Google=function(e){function t(o,i){_classCallCheck(this,t);var r=_possibleConstructorReturn(this,e.call(this,o,i));r.type="acquirer",r.id="GoogleDrive",r.title="Google Drive",r.icon=(0,_html2.default)(_templateObject),r.GoogleDrive=new _Provider2.default({host:r.opts.host,provider:"google"}),r.files=[],r.addFile=r.addFile.bind(r),r.filterItems=r.filterItems.bind(r),r.filterQuery=r.filterQuery.bind(r),r.getFolder=r.getFolder.bind(r),r.getNextFolder=r.getNextFolder.bind(r),r.handleRowClick=r.handleRowClick.bind(r),r.logout=r.logout.bind(r),r.handleDemoAuth=r.handleDemoAuth.bind(r),r.sortByTitle=r.sortByTitle.bind(r),r.sortByDate=r.sortByDate.bind(r),r.render=r.render.bind(r);var n={};return r.opts=_extends({},n,i),r}return _inherits(t,e),t.prototype.install=function(){var e=this;this.core.setState({googleDrive:{authenticated:!1,files:[],folders:[],directories:[{title:"My Drive",id:"root"}],activeRow:-1,filterInput:""}});var t=this.opts.target,o=this;this.target=this.mount(t,o),this.checkAuthentication().then(function(t){return e.updateState({authenticated:t}),console.log("are we authenticated?"),console.log(t),t?e.getFolder("root"):t}).then(function(t){e.updateState(t)})},t.prototype.focus=function(){},t.prototype.updateState=function(e){var t=this.core.state,o=_extends({},t.googleDrive,e);this.core.setState({googleDrive:o})},t.prototype.checkAuthentication=function(){var e=this;return fetch(this.opts.host+"/google/authorize",{method:"get",credentials:"include",headers:{Accept:"application/json","Content-Type":"application/json"}}).then(function(t){if(console.log(t.status),t.status<200||t.status>300){e.updateState({authenticated:!1,error:!0});var o=new Error(t.statusText);throw o.response=t,o}return t.json()}).then(function(e){return e.isAuthenticated}).catch(function(e){return e})},t.prototype.getFolder=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"root";return this.GoogleDrive.list(e).then(function(e){var t=[],o=[];return e.items.forEach(function(e){"application/vnd.google-apps.folder"===e.mimeType?t.push(e):o.push(e)}),{folders:t,files:o}}).catch(function(e){return e})},t.prototype.getNextFolder=function(e,t){var o=this;this.getFolder(e).then(function(i){var r=o.core.getState().googleDrive,n=r.directories.findIndex(function(t){return e===t.id}),l=void 0;l=n!==-1?r.directories.slice(0,n+1):r.directories.concat([{id:e,title:t}]),o.updateState(_Utils2.default.extend(i,{directories:l}))})},t.prototype.addFile=function(e){var t={source:this.id,data:e,name:e.title,type:e.mimeType,isRemote:!0,body:{fileId:e.id},remote:{host:this.opts.host,url:this.opts.host+"/google/get?fileId="+e.id,body:{fileId:e.id}}};console.log("adding file"),this.core.emitter.emit("core:file-add",t)},t.prototype.handleError=function(e){var t=this;this.checkAuthentication().then(function(e){t.updateState({authenticated:e})})},t.prototype.logout=function(){var e=this;this.GoogleDrive.logout(location.href).then(function(e){return e.json()}).then(function(t){if(t.ok){console.log("ok");var o={authenticated:!1,files:[],folders:[],directories:[{title:"My Drive",id:"root"}]};e.updateState(o)}})},t.prototype.getFileType=function(e){var t={"application/vnd.google-apps.folder":"Folder","application/vnd.google-apps.document":"Google Docs","application/vnd.google-apps.spreadsheet":"Google Sheets","application/vnd.google-apps.presentation":"Google Slides","image/jpeg":"JPEG Image","image/png":"PNG Image"};return t[e.mimeType]?t[e.mimeType]:e.fileExtension.toUpperCase()},t.prototype.handleRowClick=function(e){var t=this.core.getState().googleDrive,o=_extends({},t,{activeRow:e});this.updateState(o)},t.prototype.filterQuery=function(e){var t=this.core.getState().googleDrive;this.updateState(_extends({},t,{filterInput:e.target.value}))},t.prototype.filterItems=function(e){var t=this.core.getState().googleDrive;return e.filter(function(e){return e.title.toLowerCase().indexOf(t.filterInput.toLowerCase())!==-1})},t.prototype.sortByTitle=function(){var e=_extends({},this.core.getState().googleDrive),t=e.files,o=e.folders,i=e.sorting,r=t.sort(function(e,t){return"titleDescending"===i?t.title.localeCompare(e.title):e.title.localeCompare(t.title)}),n=o.sort(function(e,t){return"titleDescending"===i?t.title.localeCompare(e.title):e.title.localeCompare(t.title)});this.updateState(_extends({},e,{files:r,folders:n,sorting:"titleDescending"===i?"titleAscending":"titleDescending"}))},t.prototype.sortByDate=function(){var e=_extends({},this.core.getState().googleDrive),t=e.files,o=e.folders,i=e.sorting,r=t.sort(function(e,t){var o=new Date(e.modifiedByMeDate),r=new Date(t.modifiedByMeDate);return"dateDescending"===i?o>r?-1:o<r?1:0:o>r?1:o<r?-1:0}),n=o.sort(function(e,t){var o=new Date(e.modifiedByMeDate),r=new Date(t.modifiedByMeDate);return"dateDescending"===i?o>r?-1:o<r?1:0:o>r?1:o<r?-1:0});this.updateState(_extends({},e,{files:r,folders:n,sorting:"dateDescending"===i?"dateAscending":"dateDescending"}))},t.prototype.handleDemoAuth=function(){var e=this.core.getState().googleDrive;this.updateState({},e,{authenticated:!0})},t.prototype.render=function(e){var t=e.googleDrive,o=t.authenticated,i=t.error;if(i)return(0,_Error2.default)({error:i});if(!o){var r=btoa(JSON.stringify({redirect:location.href.split("#")[0]})),n=this.opts.host+"/connect/google?state="+r;return(0,_AuthView2.default)({link:n,demo:this.opts.demo,handleDemoAuth:this.handleDemoAuth})}var l=_extends({},e.googleDrive,{getNextFolder:this.getNextFolder,getFolder:this.getFolder,addFile:this.addFile,filterItems:this.filterItems,filterQuery:this.filterQuery,handleRowClick:this.handleRowClick,sortByTitle:this.sortByTitle,sortByDate:this.sortByDate,logout:this.logout,demo:this.opts.demo});return(0,_Browser2.default)(l)},t}(_Plugin3.default);exports.default=Google;
...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _taggedTemplateLiteralLoose(t,e){return t.raw=e,t}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(["\n    <li>\n      <button onclick=",">","</button>\n    </li>\n  "],["\n    <li>\n      <button onclick=",">","</button>\n    </li>\n  "]),_html=require("../../../core/html"),_html2=_interopRequireDefault(_html);exports.default=function(t){return(0,_html2.default)(_templateObject,t.getNextFolder,t.title)};
},{"../../../core/html":36}],58:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,t){return e.raw=t,e}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(['\n    <ul class="UppyGoogleDrive-breadcrumbs">\n      ',"\n    </ul>\n  "],['\n    <ul class="UppyGoogleDrive-breadcrumbs">\n      ',"\n    </ul>\n  "]),_html=require("../../../core/html"),_html2=_interopRequireDefault(_html),_Breadcrumb=require("./Breadcrumb"),_Breadcrumb2=_interopRequireDefault(_Breadcrumb);exports.default=function(e){return(0,_html2.default)(_templateObject,e.directories.map(function(t){return(0,_Breadcrumb2.default)({getNextFolder:function(){return e.getNextFolder(t.id,t.title)},title:t.title})}))};
},{"../../../core/html":36,"./Breadcrumb":57}],59:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,r){return e.raw=r,e}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(['\n    <div class="Browser">\n      <header>\n        <input\n          type="text"\n          class="Browser-search"\n          placeholder="Search Drive"\n          onkeyup=',"\n          value=",'/>\n      </header>\n      <div class="Browser-subHeader">\n        ','\n      </div>\n      <div class="Browser-body">\n        <main class="Browser-content">\n          ',"\n        </main>\n      </div>\n    </div>\n  "],['\n    <div class="Browser">\n      <header>\n        <input\n          type="text"\n          class="Browser-search"\n          placeholder="Search Drive"\n          onkeyup=',"\n          value=",'/>\n      </header>\n      <div class="Browser-subHeader">\n        ','\n      </div>\n      <div class="Browser-body">\n        <main class="Browser-content">\n          ',"\n        </main>\n      </div>\n    </div>\n  "]),_html=require("../../../core/html"),_html2=_interopRequireDefault(_html),_Breadcrumbs=require("./Breadcrumbs"),_Breadcrumbs2=_interopRequireDefault(_Breadcrumbs),_Table=require("./Table"),_Table2=_interopRequireDefault(_Table);exports.default=function(e){var r=e.folders,t=e.files;return""!==e.filterInput&&(r=e.filterItems(e.folders),t=e.filterItems(e.files)),(0,_html2.default)(_templateObject,e.filterQuery,e.filterInput,(0,_Breadcrumbs2.default)({getNextFolder:e.getNextFolder,directories:e.directories}),(0,_Table2.default)({columns:[{name:"Name",key:"title"}],folders:r,files:t,activeRow:e.activeRow,sortByTitle:e.sortByTitle,sortByDate:e.sortByDate,handleRowClick:e.handleRowClick,handleFileDoubleClick:e.addFile,handleFolderDoubleClick:e.getNextFolder}))};
},{"../../../core/html":36,"./Breadcrumbs":58,"./Table":60}],60:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,t){return e.raw=t,e}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(['\n      <th class="BrowserTable-headerColumn BrowserTable-column" onclick=',">\n        ","\n      </th>\n    "],['\n      <th class="BrowserTable-headerColumn BrowserTable-column" onclick=',">\n        ","\n      </th>\n    "]),_templateObject2=_taggedTemplateLiteralLoose(['\n    <table class="BrowserTable">\n      <thead class="BrowserTable-header">\n        <tr>\n          ',"\n        </tr>\n      </thead>\n      <tbody>\n        ","\n        ","\n      </tbody>\n    </table>\n  "],['\n    <table class="BrowserTable">\n      <thead class="BrowserTable-header">\n        <tr>\n          ',"\n        </tr>\n      </thead>\n      <tbody>\n        ","\n        ","\n      </tbody>\n    </table>\n  "]),_html=require("../../../core/html"),_html2=_interopRequireDefault(_html),_TableRow=require("./TableRow"),_TableRow2=_interopRequireDefault(_TableRow);exports.default=function(e){var t=e.columns.map(function(t){return(0,_html2.default)(_templateObject,e.sortByTitle,t.name)});return(0,_html2.default)(_templateObject2,t,e.folders.map(function(t){return(0,_TableRow2.default)({title:t.title,active:e.activeRow===t.id,iconLink:t.iconLink,modifiedByMeDate:t.modifiedByMeDate,handleClick:function(){return e.handleRowClick(t.id)},handleDoubleClick:function(){return e.handleFolderDoubleClick(t.id,t.title)},columns:e.columns})}),e.files.map(function(t){return(0,_TableRow2.default)({title:t.title,active:e.activeRow===t.id,iconLink:t.iconLink,modifiedByMeDate:t.modifiedByMeDate,handleClick:function(){return e.handleRowClick(t.id)},handleDoubleClick:function(){return e.handleFileDoubleClick(t)},columns:e.columns,owner:"Joe Mama"})}))};
},{"../../../core/html":36,"./TableRow":62}],61:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,t){return e.raw=t,e}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(['\n    <td class="BrowserTable-rowColumn BrowserTable-column">\n      <img src=',"/> ","\n    </td>\n  "],['\n    <td class="BrowserTable-rowColumn BrowserTable-column">\n      <img src=',"/> ","\n    </td>\n  "]),_html=require("../../../core/html"),_html2=_interopRequireDefault(_html);exports.default=function(e){return(0,_html2.default)(_templateObject,e.iconLink,e.value)};
},{"../../../core/html":36}],62:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,l){return e.raw=l,e}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(["\n    <tr onclick="," ondblclick="," class=",">\n      ","\n    </tr>\n  "],["\n    <tr onclick="," ondblclick="," class=",">\n      ","\n    </tr>\n  "]),_html=require("../../../core/html"),_html2=_interopRequireDefault(_html),_TableColumn=require("./TableColumn"),_TableColumn2=_interopRequireDefault(_TableColumn);exports.default=function(e){var l=e.active?"BrowserTable-row is-active":"BrowserTable-row";return(0,_html2.default)(_templateObject,e.handleClick,e.handleDoubleClick,l,(0,_TableColumn2.default)({iconLink:e.iconLink,value:e.title||""}))};
},{"../../../core/html":36,"./TableColumn":61}],63:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,t){return e.raw=t,e}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}exports.__esModule=!0;var _extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e},_templateObject=_taggedTemplateLiteralLoose(['<div class="UppyInformer" aria-hidden="','">\n      <p>',"</p>\n    </div>"],['<div class="UppyInformer" aria-hidden="','">\n      <p>',"</p>\n    </div>"]),_Plugin2=require("./Plugin"),_Plugin3=_interopRequireDefault(_Plugin2),_html=require("../core/html"),_html2=_interopRequireDefault(_html),Informer=function(e){function t(r,n){_classCallCheck(this,t);var o=_possibleConstructorReturn(this,e.call(this,r,n));o.type="progressindicator",o.id="Informer",o.title="Informer";var i={};return o.opts=_extends({},i,n),o}return _inherits(t,e),t.prototype.showInformer=function(e,t,r){var n=this;this.core.setState({informer:{isHidden:!1,msg:e}}),0!==r&&setTimeout(function(){var e=_extends({},n.core.getState().informer,{isHidden:!0});n.core.setState({informer:e})},r)},t.prototype.hideInformer=function(){var e=_extends({},this.core.getState().informer,{isHidden:!0});this.core.setState({informer:e})},t.prototype.render=function(e){var t=e.informer.msg,r=e.informer.isHidden;return(0,_html2.default)(_templateObject,r,t)},t.prototype.install=function(){var e=this;this.core.setState({informer:{isHidden:!0,msg:""}});var t=this.core.bus;t.on("informer",function(t,r,n){e.showInformer(t,r,n)}),t.on("informer-hide",function(){e.hideInformer()});var r=this.opts.target,n=this;this.target=this.mount(r,n)},t}(_Plugin3.default);exports.default=Informer;
},{"../core/html":36,"./Plugin":66}],64:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}exports.__esModule=!0;var _extends=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(t[r]=n[r])}return t},_Plugin2=require("./Plugin"),_Plugin3=_interopRequireDefault(_Plugin2),MetaData=function(t){function e(n,r){_classCallCheck(this,e);var o=_possibleConstructorReturn(this,t.call(this,n,r));o.type="modifier",o.id="MetaData",o.title="Meta Data";var i={};return o.opts=_extends({},i,r),o}return _inherits(e,t),e.prototype.addInitialMeta=function(){var t=this,e=this.opts.fields;this.core.setState({metaFields:e}),this.core.emitter.on("file-added",function(n){e.forEach(function(e){var r={};r[e.id]=e.value,t.core.updateMeta(r,n)})})},e.prototype.install=function(){this.addInitialMeta()},e}(_Plugin3.default);exports.default=MetaData;
},{"./Plugin":66}],65:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}exports.__esModule=!0;var _extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var o in r)Object.prototype.hasOwnProperty.call(r,o)&&(e[o]=r[o])}return e},_Plugin2=require("./Plugin"),_Plugin3=_interopRequireDefault(_Plugin2),_Promise="undefined"==typeof Promise?require("es6-promise").Promise:Promise,Multipart=function(e){function t(r,o){_classCallCheck(this,t);var n=_possibleConstructorReturn(this,e.call(this,r,o));n.type="uploader",n.id="Multipart",n.title="Multipart";var i={fieldName:"files[]",responseUrlFieldName:"url",bundle:!0};return n.opts=_extends({},i,o),n}return _inherits(t,e),t.prototype.upload=function(e,t,r){var o=this;return this.core.log("uploading "+t+" of "+r),new _Promise(function(t,r){var n=new FormData;n.append(o.opts.fieldName,e.data),Object.keys(e.meta).forEach(function(t){console.log(e.meta,e.meta[t]),n.append(t,e.meta[t])});var i=new XMLHttpRequest;i.upload.addEventListener("progress",function(t){t.lengthComputable&&o.core.emitter.emit("core:upload-progress",{uploader:o,id:e.id,bytesUploaded:t.loaded,bytesTotal:t.total})}),i.addEventListener("load",function(n){if(200===n.target.status){var a=JSON.parse(i.response),s=a[o.opts.responseUrlFieldName];return o.core.emitter.emit("core:upload-success",e.id,s),o.core.log("Download "+e.name+" from "+e.uploadURL),t(e)}return o.core.emitter.emit("core:upload-error",e.id,i),r("Upload error")}),i.addEventListener("error",function(t){return o.core.emitter.emit("core:upload-error",e.id),r("Upload error")}),i.open("POST",o.opts.endpoint,!0),i.send(n),o.core.emitter.emit("core:upload-started",e.id)})},t.prototype.selectForUpload=function(e){var t=this;if(0===Object.keys(e).length)return void this.core.log("no files to upload!");var r=[];Object.keys(e).forEach(function(t){e[t].progress.uploadStarted&&!e[t].isRemote||r.push(e[t])});var o=[];return r.forEach(function(e,n){var i=parseInt(n,10)+1,a=r.length;o.push(t.upload(e,i,a))}),Promise.all(o).then(function(e){t.core.log("Multipart has finished uploading!")})},t.prototype.install=function(){var e=this,t=this.core.emitter;t.on("core:upload",function(){e.core.log("Multipart is uploading...");var t=e.core.getState().files;e.selectForUpload(t)})},t}(_Plugin3.default);exports.default=Multipart;
},{"./Plugin":66,"es6-promise":7}],66:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}exports.__esModule=!0;var _yoYo=require("yo-yo"),_yoYo2=_interopRequireDefault(_yoYo),Plugin=function(){function t(e,o){_classCallCheck(this,t),this.core=e,this.opts=o||{},this.type="none",this.opts.replaceTargetContent===this.opts.replaceTargetContent||!0,this.update=this.update.bind(this),this.mount=this.mount.bind(this),this.focus=this.focus.bind(this),this.install=this.install.bind(this)}return t.prototype.update=function(t){if("undefined"!=typeof this.el){var e=this.render(t);_yoYo2.default.update(this.el,e)}},t.prototype.mount=function(t,e){var o=e.id;if("string"==typeof t)return this.core.log("Installing "+o+" to "+t),this.opts.replaceTargetContent&&(document.querySelector(t).innerHTML=""),this.el=e.render(this.core.state),document.querySelector(t).appendChild(this.el),t;var i=t,n=(new i).id;this.core.log("Installing "+o+" to "+n);var s=this.core.getPlugin(n),r=s.addTarget(e);return r},t.prototype.focus=function(){},t.prototype.install=function(){},t}();exports.default=Plugin;
},{"yo-yo":23}],67:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,t){return e.raw=t,e}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}exports.__esModule=!0;var _extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e},_templateObject=_taggedTemplateLiteralLoose(['<div class="UppyProgressBar" style="','">\n      <div class="UppyProgressBar-inner" style="width: ','%"></div>\n      <div class="UppyProgressBar-percentage">',"</div>\n    </div>"],['<div class="UppyProgressBar" style="','">\n      <div class="UppyProgressBar-inner" style="width: ','%"></div>\n      <div class="UppyProgressBar-percentage">',"</div>\n    </div>"]),_Plugin2=require("./Plugin"),_Plugin3=_interopRequireDefault(_Plugin2),_html=require("../core/html"),_html2=_interopRequireDefault(_html),ProgressBar=function(e){function t(r,n){_classCallCheck(this,t);var s=_possibleConstructorReturn(this,e.call(this,r,n));s.id="ProgressBar",s.title="Progress Bar",s.type="progressindicator";var o={replaceTargetContent:!1,fixed:!1};return s.opts=_extends({},o,n),s.render=s.render.bind(s),s}return _inherits(t,e),t.prototype.render=function(e){var t=e.totalProgress||0;return(0,_html2.default)(_templateObject,this.opts.fixed?"position: fixed":"null",t,t)},t.prototype.install=function(){var e=this.opts.target,t=this;this.target=this.mount(e,t)},t}(_Plugin3.default);exports.default=ProgressBar;
},{"../core/html":36,"./Plugin":66}],68:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}exports.__esModule=!0;var _extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var r in o)Object.prototype.hasOwnProperty.call(o,r)&&(e[r]=o[r])}return e},_Plugin2=require("./Plugin"),_Plugin3=_interopRequireDefault(_Plugin2),_tusJsClient=require("tus-js-client"),_tusJsClient2=_interopRequireDefault(_tusJsClient),_UppySocket=require("../core/UppySocket"),_UppySocket2=_interopRequireDefault(_UppySocket),_Promise="undefined"==typeof Promise?require("es6-promise").Promise:Promise,Tus10=function(e){function t(o,r){_classCallCheck(this,t);var s=_possibleConstructorReturn(this,e.call(this,o,r));s.type="uploader",s.id="Tus",s.title="Tus";var i={resume:!0,allowPause:!0};return s.opts=_extends({},i,r),s}return _inherits(t,e),t.prototype.pauseResume=function(e,t){var o=_extends({},this.core.getState().files),r=Object.keys(o).filter(function(e){return!o[e].progress.uploadComplete&&o[e].progress.uploadStarted});switch(e){case"toggle":if(o[t].uploadComplete)return;var s=o[t].isPaused||!1,i=!s,n=void 0;return n=s?_extends({},o[t],{isPaused:!1}):_extends({},o[t],{isPaused:!0}),o[t]=n,this.core.setState({files:o}),i;case"pauseAll":return r.forEach(function(e){var t=_extends({},o[e],{isPaused:!0});o[e]=t}),void this.core.setState({files:o});case"resumeAll":return r.forEach(function(e){var t=_extends({},o[e],{isPaused:!1});o[e]=t}),void this.core.setState({files:o})}},t.prototype.upload=function(e,t,o){var r=this;return this.core.log("uploading "+t+" of "+o),new _Promise(function(t,o){var s=new _tusJsClient2.default.Upload(e.data,{metadata:e.meta,resume:r.opts.resume,endpoint:r.opts.endpoint,onError:function(t){r.core.log(t),r.core.emitter.emit("core:upload-error",e.id),o("Failed because: "+t)},onProgress:function(t,o){r.core.emitter.emit("core:upload-progress",{uploader:r,id:e.id,bytesUploaded:t,bytesTotal:o})},onSuccess:function(){r.core.emitter.emit("core:upload-success",e.id,s.url),r.core.log("Download "+s.file.name+" from "+s.url),t(s)}});r.core.emitter.on("core:file-remove",function(o){o===e.id&&(console.log("removing file: ",o),s.abort(),t("upload "+o+" was removed"))}),r.core.emitter.on("core:upload-pause",function(t){if(t===e.id){var o=r.pauseResume("toggle",t);o?s.abort():s.start()}}),r.core.emitter.on("core:pause-all",function(){var t=r.core.getState().files;t[e.id]&&s.abort()}),r.core.emitter.on("core:resume-all",function(){var t=r.core.getState().files;t[e.id]&&s.start()}),s.start(),r.core.emitter.emit("core:upload-started",e.id,s)})},t.prototype.uploadRemote=function(e,t,o){var r=this;return new _Promise(function(t,o){r.core.log(e.remote.url),fetch(e.remote.url,{method:"post",credentials:"include",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify(_extends({},e.remote.body,{target:r.opts.endpoint,protocol:"tus"}))}).then(function(s){return s.status<200&&s.status>300?o(s.statusText):void s.json().then(function(o){var s=/^(?:https?:\/\/)?(?:[^@\/\n]+@)?(?:www\.)?([^:\/\n]+)/,i=s.exec(e.remote.host)[1],n=o.token,a=new _UppySocket2.default({target:"ws://"+i+":3020/api/"+n});a.on("progress",function(o){var s=o.progress,i=o.bytesUploaded,n=o.bytesTotal;if(s&&(r.core.log("Upload progress: "+s),r.core.emitter.emit("core:upload-progress",{uploader:r,id:e.id,bytesUploaded:i,bytesTotal:n}),"100.00"===s))return r.core.emitter.emit("core:upload-success",e.id),a.close(),t()})})})})},t.prototype.uploadFiles=function(e){var t=this;if(0===Object.keys(e).length)return void this.core.log("no files to upload!");var o=[];return e.forEach(function(r,s){var i=parseInt(s,10)+1,n=e.length;r.isRemote?o.push(t.uploadRemote(r,i,n)):o.push(t.upload(r,i,n))}),Promise.all(o).then(function(){return t.core.log("All files uploaded"),{uploadedCount:e.length}}).catch(function(e){t.core.log("Upload error: "+e)})},t.prototype.selectForUpload=function(e){var t=Object.keys(e).filter(function(t){return!(e[t].progress.uploadStarted&&!e[t].isRemote)}).map(function(t){return e[t]});this.uploadFiles(t)},t.prototype.actions=function(){var e=this;this.core.emitter.on("core:pause-all",function(){e.pauseResume("pauseAll")}),this.core.emitter.on("core:resume-all",function(){e.pauseResume("resumeAll")}),this.core.emitter.on("core:upload",function(){e.core.log("Tus is uploading...");var t=e.core.getState().files;e.selectForUpload(t)})},t.prototype.addResumableUploadsCapabilityFlag=function(){var e=_extends({},this.core.getState().capabilities);e.resumableUploads=!0,this.core.setState({capabilities:e})},t.prototype.install=function(){this.addResumableUploadsCapabilityFlag(),this.actions()},t}(_Plugin3.default);exports.default=Tus10;
},{"../core/UppySocket":34,"./Plugin":66,"es6-promise":7,"tus-js-client":19}],69:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,t){return e.raw=t,e}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(['<svg class="UppyIcon" width="100" height="77" viewBox="0 0 100 77">\n    <g>\n      <path d="M50 32c-7.168 0-13 5.832-13 13s5.832 13 13 13 13-5.832 13-13-5.832-13-13-13z"/>\n      <path d="M87 13H72c0-7.18-5.82-13-13-13H41c-7.18 0-13 5.82-13 13H13C5.82 13 0 18.82 0 26v38c0 7.18 5.82 13 13 13h74c7.18 0 13-5.82 13-13V26c0-7.18-5.82-13-13-13zM50 68c-12.683 0-23-10.318-23-23s10.317-23 23-23 23 10.318 23 23-10.317 23-23 23z"/>\n    <g>\n  </svg>'],['<svg class="UppyIcon" width="100" height="77" viewBox="0 0 100 77">\n    <g>\n      <path d="M50 32c-7.168 0-13 5.832-13 13s5.832 13 13 13 13-5.832 13-13-5.832-13-13-13z"/>\n      <path d="M87 13H72c0-7.18-5.82-13-13-13H41c-7.18 0-13 5.82-13 13H13C5.82 13 0 18.82 0 26v38c0 7.18 5.82 13 13 13h74c7.18 0 13-5.82 13-13V26c0-7.18-5.82-13-13-13zM50 68c-12.683 0-23-10.318-23-23s10.317-23 23-23 23 10.318 23 23-10.317 23-23 23z"/>\n    <g>\n  </svg>']),_html=require("../../core/html"),_html2=_interopRequireDefault(_html);exports.default=function(e){return(0,_html2.default)(_templateObject)};
},{"../../core/html":36}],70:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,a){return e.raw=a,e}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(['<video class="UppyWebcam-video" autoplay src="','"></video>'],['<video class="UppyWebcam-video" autoplay src="','"></video>']),_templateObject2=_taggedTemplateLiteralLoose(["\n    <div class=\"UppyWebcam-container\">\n      <div class='UppyWebcam-videoContainer'>\n        ",'\n      </div>\n      <div class=\'UppyWebcam-buttonContainer\'>\n        <button class="UppyButton--circular UppyButton--red UppyButton--sizeM UppyWebcam-stopRecordBtn"\n          type="button"\n          title="Take a snapshot"\n          aria-label="Take a snapshot"\n          onclick=',">\n          ",'\n        </button>\n      </div>\n      <canvas class="UppyWebcam-canvas" style="display: none;"></canvas>\n    </div>\n  '],["\n    <div class=\"UppyWebcam-container\">\n      <div class='UppyWebcam-videoContainer'>\n        ",'\n      </div>\n      <div class=\'UppyWebcam-buttonContainer\'>\n        <button class="UppyButton--circular UppyButton--red UppyButton--sizeM UppyWebcam-stopRecordBtn"\n          type="button"\n          title="Take a snapshot"\n          aria-label="Take a snapshot"\n          onclick=',">\n          ",'\n        </button>\n      </div>\n      <canvas class="UppyWebcam-canvas" style="display: none;"></canvas>\n    </div>\n  ']),_html=require("../../core/html"),_html2=_interopRequireDefault(_html),_CameraIcon=require("./CameraIcon"),_CameraIcon2=_interopRequireDefault(_CameraIcon);exports.default=function(e){var a=void 0;return a=e.useTheFlash?e.getSWFHTML():(0,_html2.default)(_templateObject,e.src),(0,_html2.default)(_templateObject2,a,e.onSnapshot,(0,_CameraIcon2.default)())};
},{"../../core/html":36,"./CameraIcon":69}],71:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _taggedTemplateLiteralLoose(e,t){return e.raw=t,e}exports.__esModule=!0;var _templateObject=_taggedTemplateLiteralLoose(["\n    <div>\n      <h1>Please allow access to your camera</h1>\n      <span>You have been prompted to allow camera access from this site. In order to take pictures with your camera you must approve this request.</span>\n    </div>\n  "],["\n    <div>\n      <h1>Please allow access to your camera</h1>\n      <span>You have been prompted to allow camera access from this site. In order to take pictures with your camera you must approve this request.</span>\n    </div>\n  "]),_html=require("../../core/html"),_html2=_interopRequireDefault(_html);exports.default=function(e){return(0,_html2.default)(_templateObject)};
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}exports.__esModule=!0;var _extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var a in r)Object.prototype.hasOwnProperty.call(r,a)&&(e[a]=r[a])}return e},_Plugin2=require("../Plugin"),_Plugin3=_interopRequireDefault(_Plugin2),_Webcam=require("../../uppy-base/src/plugins/Webcam"),_Webcam2=_interopRequireDefault(_Webcam),_Utils=require("../../core/Utils"),_WebcamIcon=require("./WebcamIcon"),_WebcamIcon2=_interopRequireDefault(_WebcamIcon),_CameraScreen=require("./CameraScreen"),_CameraScreen2=_interopRequireDefault(_CameraScreen),_PermissionsScreen=require("./PermissionsScreen"),_PermissionsScreen2=_interopRequireDefault(_PermissionsScreen),Webcam=function(e){function t(r,a){_classCallCheck(this,t);var n=_possibleConstructorReturn(this,e.call(this,r,a));n.userMedia=!0,n.protocol=location.protocol.match(/https/i)?"https":"http",n.type="acquirer",n.id="Webcam",n.title="Webcam",n.icon=(0,_WebcamIcon2.default)();var o={enableFlash:!0};return n.params={swfURL:"webcam.swf",width:400,height:300,dest_width:800,dest_height:600,image_format:"jpeg",jpeg_quality:90,enable_flash:!0,force_flash:!1,flip_horiz:!1,fps:30,upload_name:"webcam",constraints:null,flashNotDetectedText:"ERROR: No Adobe Flash Player detected.  Webcam.js relies on Flash for browsers that do not support getUserMedia (like yours).",noInterfaceFoundText:"No supported webcam interface found.",unfreeze_snap:!0},n.opts=_extends({},o,a),n.install=n.install.bind(n),n.updateState=n.updateState.bind(n),n.render=n.render.bind(n),n.start=n.start.bind(n),n.takeSnapshot=n.takeSnapshot.bind(n),n.webcam=new _Webcam2.default(n.opts,n.params),n}return _inherits(t,e),t.prototype.start=function(){var e=this;this.webcam.start().then(function(t){e.updateState({videoStream:t,cameraReady:!0})}).catch(function(t){e.updateState({cameraError:t})})},t.prototype.takeSnapshot=function(){var e={name:"webcam-"+Date.now()+".jpg",mimeType:"image/jpeg"},t=document.querySelector(".UppyWebcam-video"),r=this.webcam.getImage(t,e),a={source:this.id,name:e.name,data:r.data,type:e.mimeType};this.core.emitter.emit("core:file-add",a)},t.prototype.render=function(e){return e.webcam.cameraReady||e.webcam.useTheFlash?(this.stream||(this.stream=e.webcam.videoStream?URL.createObjectURL(e.webcam.videoStream):null),(0,_CameraScreen2.default)((0,_Utils.extend)(e.webcam,{onSnapshot:this.takeSnapshot,getSWFHTML:this.webcam.getSWFHTML,src:this.stream}))):(0,_PermissionsScreen2.default)(e.webcam)},t.prototype.focus=function(){var e=this,t=document.querySelector(".UppyWebcam-stopRecordBtn");t&&setTimeout(function(){t.focus()},10),this.start(),setTimeout(function(){e.core.emitter.emit("informer","Smile!","info",3500)},1e3)},t.prototype.install=function(){this.webcam.init(),this.core.setState({webcam:{cameraReady:!1}});var e=this.opts.target,t=this;this.target=this.mount(e,t)},t.prototype.updateState=function(e){var t=this.core.state,r=_extends({},t.webcam,e);this.core.setState({webcam:r})},t}(_Plugin3.default);exports.default=Webcam;
